package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1232:int = 1;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         var _loc3_:Conversation = method_9(param1);
         if(_loc3_ == null)
         {
            return null;
         }
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_679,0,var_404.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      
      private function method_9(param1:int) : Conversation
      {
      ...
      {
         return new Message(Message.const_586,0,getOnlineText(param1),Util.getFormattedNow());
      }
