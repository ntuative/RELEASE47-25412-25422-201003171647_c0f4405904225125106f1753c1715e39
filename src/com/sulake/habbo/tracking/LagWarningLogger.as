package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1237 || var_1394 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1393 == 0 || _loc1_ - var_1393 > var_1394)
         {
            if(_connection != null)
            {
      ...
      {
         var_1237 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1394 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
