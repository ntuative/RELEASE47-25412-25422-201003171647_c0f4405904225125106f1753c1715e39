package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_768:uint = 11;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1290 = new Array(const_768);
         var _loc4_:int = 0;
         while(_loc4_ < const_768)
         {
            var_1290[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1268,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1179,Capabilities.serverString);
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_587:
               trackLoginStep(HabboLoginTrackingStep.const_1282,String(_communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_195:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_195);
               if(var_231 != null)
               {
                  var_231.init();
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_152)
         {
            Component(var_152).events.addEventListener(HabboConfigurationEvent.const_178,onConfigurationLoaded);
            if(var_231 != null)
            {
               var_231.configuration = var_152;
            }
            if(var_230 != null)
            {
               var_230.configuration = var_152;
            }
            if(var_870 != null)
            {
               var_870.configure(var_152);
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_251.events.addEventListener(AdEvent.const_373,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2079)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1376);
            var_2079 = true;
         }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_587,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_195,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_644,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_61,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_453,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_393:
         ...
         if(!disposed)
         {
            ...
            if(var_171)
            {
               if(true)
               {
                  ...
                  Component(var_171).events.removeEventListener(HabboFriendListTrackingEvent.const_298,onFriendlistTrackingEvent);
               }
            ...
            if(var_126)
            {
               if(true)
               {
                  var_126.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_126.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_126.release(new IIDHabboHelp());
               var_126 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_393,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_152)
         {
            Component(var_152).events.removeEventListener(HabboConfigurationEvent.const_178,onConfigurationLoaded);
         }
      }
      ...
      {
         var_126 = param2 as IHabboHelp;
         var_126.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_126.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_810);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_810,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1055 > -1 && _loc2_ < var_1055)
         {
            ++var_1525;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1525);
         }
         if(var_1055 > -1 && _loc2_ - var_1055 > 15000)
         {
            ++var_1524;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1524);
         }
         var_1055 = _loc2_;
         if(var_230 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_393,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_273,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_171).events.addEventListener(HabboFriendListTrackingEvent.const_298,onFriendlistTrackingEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_644)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1247);
         }
         else if(param1.type == HabboHotelViewEvent.const_453)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1343);
         }
         else if(param1.type == HabboHotelViewEvent.const_61)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1163);
         }
      }
   }
}
