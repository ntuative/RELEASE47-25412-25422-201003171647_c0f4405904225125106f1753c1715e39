package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2269:BitmapData;
      
      protected var var_929:Boolean;
      
      protected var var_2266:Boolean;
      
      protected var var_1966:int;
      ...
      private const const_1625:int = 8947848;
      ...
      private const const_1407:Number = 0.2;
      
      protected var var_1371:Boolean;
      
      private const const_1406:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_723)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1454));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1378);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1371 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2269;
               _loc5_.visible = true;
            }
            else
            {
