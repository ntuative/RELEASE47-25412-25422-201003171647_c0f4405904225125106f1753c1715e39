package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_527);
         _loc2_.refreshViews();
         var_10.notifyChangedEffects();
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_151);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_10.setInventoryCategoryInit(InventoryCategory.const_287);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         while(_loc12_ < _loc3_.length)
         {
            ...
            if(_loc9_.indexOf(_loc6_.stripId) == -1)
            {
               ...
               {
                  _loc5_ = new FloorItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.isGroupable,_loc6_.method_1,_loc6_.isRecyclable,_loc6_.isSellable,_loc6_.stuffData,_loc6_.extra,_loc6_.expiryTime,0,0,0,_loc6_.slotId,_loc6_.songId);
               }
               else
               {
                  ...
                  _loc5_ = new WallItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.isGroupable,_loc6_.method_1,_loc6_.isRecyclable,_loc6_.isSellable,_loc6_.stuffData,_loc6_.extra);
               }
               if(_loc7_.length == 0)
               {
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_10.toggleInventorySubPage(InventorySubCategory.const_247);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_440);
         var _loc4_:FurniModel = var_10.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
