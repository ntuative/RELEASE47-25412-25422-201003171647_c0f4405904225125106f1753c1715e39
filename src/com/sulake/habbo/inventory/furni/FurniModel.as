package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_517 = new Timer(const_1109,1);
         var_517.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_12.getSubCategoryViewId() == InventorySubCategory.const_247;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_430.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_430.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_723)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_517 != null)
            {
               var_517.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_517.stop();
               var_517 = null;
            }
            if(var_141 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_336)
         {
         ...
         else if(param3 == FurniCategory.const_282)
         {
      ...
      {
         var_12.checkCategoryInitilization(InventoryCategory.const_440);
         ...
         if(param1 == InventoryCategory.const_76 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_333:
                  var_12.toggleInventoryPage(InventoryCategory.const_151);
            }
         }
      }
      ...
      {
         if(var_903 && param1.type == RoomEngineObjectEvent.const_222)
         {
            var_12.showView();
            var_903 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_282 || _loc3_.category == FurniCategory.const_336 || _loc3_.category == FurniCategory.const_311)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_430.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_430 = new Map();
         var_430.add(const_42,new Array());
         var_430.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
