package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      private var var_364:Object;
      
      private var var_525:IItemGridWindow;
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(_view != null)
         {
            var_525 = _view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = var_525.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            var_525.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var_525.addGridItemAt(param1,param2);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_51)
         {
            ...
            _model.toggleItemSelection(_category,var_525.getGridItemIndex(param1.window));
            var_364 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_29 && var_364 != null && var_364 == param2 && true)
         {
