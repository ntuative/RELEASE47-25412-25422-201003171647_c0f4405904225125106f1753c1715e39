package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1500,var_1501);
         }
      }
      ...
      {
         if(param1 != var_1994 || param2 != var_1993)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1777);
      }
      ...
      {
         if(var_12 != null && false && var_221 != null)
         {
            var_12.furniModel.removeLockFrom(var_221.id);
            var_221 = null;
         }
      }
