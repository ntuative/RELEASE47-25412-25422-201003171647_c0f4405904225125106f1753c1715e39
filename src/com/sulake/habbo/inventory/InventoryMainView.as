package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_834:Boolean = true;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(var_1238);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_691 == InventoryCategory.const_151)
            {
               toggleCategoryView(InventoryCategory.const_151);
            }
            else if(var_691 == InventoryCategory.const_76)
            {
               toggleCategoryView(InventoryCategory.const_76);
            }
            else if(var_12 != null)
            {
               var_12.toggleInventoryPage(InventoryCategory.const_76);
            }
         }
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_189 != null)
         {
            var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_189 != null)
         {
            var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_734,HabboToolbarIconEnum.INVENTORY,var_14 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         var_12.inventoryViewOpened(var_692);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_691 || !var_12.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_189 != null && var_834)
