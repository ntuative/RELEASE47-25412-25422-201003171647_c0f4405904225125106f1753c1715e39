package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1040:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_1039 = param5;
         var_854 = param6;
         var_226 = Math.floor(var_1039 / _thumbWidth);
         var_20 = new BitmapData(var_1039,var_854);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_485 - 1)
         {
            ...
            var_20.fillRect(new Rectangle(0,0 - var_91,var_20.width,var_91),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_20.width,0 - var_91);
               _loc2_ = new Rectangle(0,0,var_20.width,0 - var_91);
               _loc11_.copyPixels(var_20,_loc2_,new Point(0,0),null,null,true);
               var_20 = _loc11_;
               --var_485;
            }
         }
         if(var_20.height < var_854)
         {
            _loc12_ = new BitmapData(var_20.width,var_854);
      ...
      private function getList() : Array
      {
         ...
         if(var_1040 != null)
         {
            _loc1_ = var_1040.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_20 = new BitmapData(Math.max(var_226 * _thumbWidth,var_1039),Math.max(var_485 * var_91,var_854),true,16777215);
            ...
            while(_loc4_ < var_226)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_20.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_91),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_226 && var_20.height < _loc3_.y * var_91)
         {
            _loc2_ = new BitmapData(var_20.width,var_20.height + var_91);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_226 - 1),var_91);
         ...
         _loc2_.copyPixels(var_20,_loc4_,new Point(0,var_91),null,null,true);
         _loc4_ = new Rectangle(0,var_91,_thumbWidth * (var_226 - 1),0 - var_91);
         _loc2_.copyPixels(var_20,_loc4_,new Point(_thumbWidth,var_91),null,null,true);
         var_20 = _loc2_;
      }
