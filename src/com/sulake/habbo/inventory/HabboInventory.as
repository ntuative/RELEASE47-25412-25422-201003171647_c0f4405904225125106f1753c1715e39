package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_859:IRoomSession;
      ...
      private const const_1633:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            var_19.events.removeEventListener(RoomSessionEvent.const_94,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionEvent.const_103,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_454,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_48.getValue(InventoryCategory.const_527));
      }
      ...
      {
         var_147.clubPeriods = param1;
         var_147.clubDays = param2;
         var_147.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_48.getValue(InventoryCategory.const_151));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_989));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1633);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_48.getValue(InventoryCategory.const_287));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_247:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_860.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_860.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_48.getValue(InventorySubCategory.const_247));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_333 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_860.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_147.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_48.getValue(InventoryCategory.const_440) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1041 = new IncomingMessages(this);
      ...
      {
         return var_147.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_147.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_48.getValue(InventoryCategory.const_270));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_94,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionEvent.const_103,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_454,roomSessionEventHandler);
         ...
         var_48.add(InventoryCategory.const_440,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_333);
         var_48.add(InventoryCategory.const_270,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_48.add(InventoryCategory.const_527,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_333);
         var_48.add(InventoryCategory.const_287,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_48.add(InventorySubCategory.const_247,_loc8_);
         ...
         var_48.add(InventoryCategory.const_151,_loc10_);
