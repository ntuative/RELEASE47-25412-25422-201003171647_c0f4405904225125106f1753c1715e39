package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1215 && param1.type == RoomEngineObjectEvent.const_222)
         {
            var_12.showView();
            var_1215 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1215 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_36,RoomObjectTypeEnum.const_338,_loc3_.figure);
            var_12.closeView();
            return;
         }
      ...
      {
         if(var_990.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
