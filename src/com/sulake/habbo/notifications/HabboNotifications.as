package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1043:String = "pet_inventory";
      
      private static const const_1042:String = "pixelbalance";
      
      private static const const_1044:String = "credits";
      
      private static const const_1046:String = "inventory";
      
      private static const const_1047:String = "friendlist";
      
      private static const const_1045:String = "selectfurni";
      
      private static const const_1041:String = "selectbadge";
      ...
      private var var_551:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_382:HabboNotificationViewManager;
      ...
      private var var_651:ClubGiftNotification;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_651 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_932)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1334);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_77:
               ...
               break;
            case CatalogPageMessageProductData.const_216:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1744)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_984);
            var_1744 = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_551)
         {
            var_551.release(new IIDHabboToolbar());
            var_551 = null;
         }
         if(_windowManager)
         {
      ...
      {
         if(param1 != null && this.var_382 != null)
         {
            var_382.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_984,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_548.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_894,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_170 || param2.type == WindowEvent.const_538)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_382.isSpaceAvailable() && false)
         {
            var_382.showItem(getNextItemFromQueue());
         }
      }
      ...
      {
         var _loc1_:Array = var_975.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_548.createPetImage(_loc2_.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_333);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               {
                  _loc15_ = var_333.getFloorItemData(_loc14_.furniClassId);
               }
               else if(_loc14_.productType == CatalogPageMessageProductData.const_77)
               {
                  _loc15_ = var_333.getWallItemData(_loc14_.furniClassId);
               }
               _loc6_ = var_333.getProductData(_loc4_.localizationId);
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_1328,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_548.createAvatarImage(param2,AvatarScaleType.const_52);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_205);
         }
      }
      ...
      {
         var_551 = IHabboToolbar(param2);
         var_551.events.addEventListener(HabboToolbarEvent.const_84,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_333.userId == _loc2_.userId)
         {
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_282;
            }
            if(param2 == 4057)
            {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_84)
         {
            ...
            var_382 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_776["styles"],var_776["view"],var_551);
            ...
            registerUpdateReceiver(var_382,1);
            registerUpdateReceiver(this,2);
            var_333.events.addEventListener(BadgeImageReadyEvent.const_117,onBadgeImage);
            var_551.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
