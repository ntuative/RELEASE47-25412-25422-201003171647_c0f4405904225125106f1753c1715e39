package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1409:uint = 4.294967295E9;
      ...
      private var var_458:IWindowContainer;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_214.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1410) : uint(const_1409);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_572,var_77,var_965);
               dispose();
               break;
            case "cancel_button":
      ...
      {
         if(var_214 == null || true)
         {
            return;
         }
         var _loc1_:IItemListWindow = var_214.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(var_543[var_183]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_542[_ribbonIndex]);
         _catalog.purchaseProductAsGift(var_572,var_77,var_965,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_51:
               ...
               break;
            case WindowKeyboardEvent.const_691:
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = var_77.productContainer.firstProduct;
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_77:
                  ...
                  break;
               case ProductTypeEnum.const_216:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1415 = _loc1_.stuffTypes;
            var_543 = _loc1_.boxTypes;
            var_542 = _loc1_.ribbonTypes;
            var_764 = var_1415[0];
            var_183 = var_543[0];
            _ribbonIndex = var_542[0];
            initColorGrid();
            updateColorGrid();
            updatePreview();
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_214.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_214 == null)
         {
            var_214 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_458 == null)
         {
            var_458 = createWindow("suggestion_list_item") as IWindowContainer;
            var_458.procedure = suggestionsEventHandler;
         }
         if(var_214 == null || var_458 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_214.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_458.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
