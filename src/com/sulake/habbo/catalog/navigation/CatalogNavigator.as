package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2343:String = "magic.pixels";
      
      private var var_2344:String = "catalog.page.club";
      
      private var var_2356:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","com.sulake.habbo.communication.messages.incoming.help") == "true";
         if(false && _loc1_)
         {
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_246.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_246)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_246.indexOf(_loc6_);
            var_246.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
