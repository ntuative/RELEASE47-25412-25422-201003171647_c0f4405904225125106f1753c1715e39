package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1072:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1465:XML;
      
      private static var var_1466:XML;
      ...
      private var var_1467:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1467 == 4294967295)
            {
               var_1467 = _loc1_.color;
            }
            _loc1_.color = const_1072;
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1465) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_50 = navigator.catalog.windowManager.buildFromXML(var_1466) as IItemListWindow;
         if(var_50 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1291;
            }
         }
      }
