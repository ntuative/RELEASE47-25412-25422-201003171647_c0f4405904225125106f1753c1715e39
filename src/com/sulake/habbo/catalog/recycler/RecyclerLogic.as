package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_786:int = 0;
      ...
      {
         return method_4 && systemActive;
      }
      
      private function updateRecyclerButton() : void
      {
         if(_view == null || !method_4)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1579)
         {
            case RecyclerStatusMessageEvent.const_1301:
               var_284 = const_350;
               if(_view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_968:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1250:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1579 != RecyclerStatusMessageEvent.const_968;
      }
      
      private function get method_4() : Boolean
      {
         return var_284 != const_786;
      }
      ...
      {
         return active && var_284 == const_350;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_932:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1353:
