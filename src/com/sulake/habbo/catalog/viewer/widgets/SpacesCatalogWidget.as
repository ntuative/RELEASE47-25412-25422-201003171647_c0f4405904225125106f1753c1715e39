package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_186:String = "landscape";
      ...
      private var var_1289:String = "HabboNavigatorCom_model_w_png";
      ...
      private var var_1287:String = "1.1";
      ...
      private var _floorType:String = "HabboNavigatorCom_model_w_png";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_259 != null && var_260 != null)
         {
            setRoomImage(var_259,var_260);
         }
      }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case const_185:
               ...
               if(var_307 >= _activeFloorPatterns.length)
               {
                  var_307 = 0;
               }
               var_258 = 0;
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1289);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1263[var_305];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1287);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1289,var_1287,64,this,"window_romantic_wide");
