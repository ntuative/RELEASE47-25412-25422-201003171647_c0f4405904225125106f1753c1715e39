package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1032:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1032 != null)
         {
            var_1032.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1031 != null)
         {
            var_1031.removeEventListener(WindowKeyboardEvent.const_148,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1032 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1032 != null)
         {
            var_1032.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1031 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1031 != null)
         {
            var_1031.addEventListener(WindowKeyboardEvent.const_148,windowKeyEventProcessor);
         }
      }
