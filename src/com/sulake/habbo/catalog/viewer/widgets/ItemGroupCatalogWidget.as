package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_602[var_1069] as Array;
      ...
      {
         var _loc2_:Offer = var_602[var_1069][var_2155];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_362 || _loc1_.pricingModel == Offer.const_385)
            {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_77 || _loc3_.productType == ProductTypeEnum.const_83)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1070.indexOf(_loc5_) == -1)
                        {
                           ...
                           var_602.push(new Array());
                        }
                        _loc6_ = var_1070.indexOf(_loc5_);
                        (var_602[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_602)
         {
            if(var_2155 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2155] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1069 = var_930.getGridItemIndex(param1.view);
