package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_566:IItemGridWindow;
      
      private var var_82:IBitmapWrapperWindow;
      
      private var var_1356:ITextWindow;
      
      private var var_1189:IScrollbarWindow;
      
      protected var var_1377:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1356.text = "${" + _loc3_.name + "}";
            var_1357.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1356.text = "${" + _loc2_.localizationId + "}";
            var_1357.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_476:
                  _loc4_ = var_1190.clone();
                  if(var_566 != null)
                  {
                     var_566.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_566,var_1189,var_1377);
                  }
                  break;
               case Offer.const_362:
                     ...
                     case ProductTypeEnum.const_216:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_331,AvatarAction.const_685);
                              _loc13_.appendAction(AvatarAction.const_542,_loc6_.productClassId);
      ...
      {
         var_1356 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1357 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1446 = new Point(var_82.x,var_82.y);
         var_566 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1189 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_566 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1377 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1190 = _loc2_.content as BitmapData;
