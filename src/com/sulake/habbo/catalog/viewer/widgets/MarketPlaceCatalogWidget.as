package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1637:int = 40;
      
      private var var_504:IWindowContainer;
      
      private const const_1423:int = 2;
      ...
      private const const_1636:int = 10;
      ...
      private function updateList() : void
      {
         ...
         updateStatusDisplay(const_1423,_loc2_.length);
         if(!var_420)
         {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_577)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1422);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_421.length)
         {
            _loc4_ = 0;
         }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_882 >= var_577.length)
            {
               return true;
            }
            addListItem(var_577.getWithIndex(var_882));
            ++var_882;
            _loc1_++;
         }
         return false;
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_158)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_421));
            _loc7_.selection = 0;
         }
      }
