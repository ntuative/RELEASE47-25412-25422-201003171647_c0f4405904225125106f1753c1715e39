package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function attachStub(param1:String) : void
      {
         ...
         var_1516 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         var_1517 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         var_2315 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         var_863 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         if(var_863 != null)
         {
            var_863.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onPurchase);
            var_863.disable();
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2044 = _loc3_.content as XML;
         }
         ...
         events.addEventListener(WidgetEvent.const_811,onSetParameter);
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_1516 != null)
         {
            ...
            var_1516.caption = "${catalog.purchase.price.pixels}";
         }
         if(var_1517 != null)
         {
            ...
            var_1517.caption = "${catalog.purchase.price.credits+pixels}";
         }
         if(var_863 != null)
         {
            var_863.enable();
