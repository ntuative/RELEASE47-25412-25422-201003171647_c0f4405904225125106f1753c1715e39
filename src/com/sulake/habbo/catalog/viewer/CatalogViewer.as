package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1474:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_572 != null)
         {
            if(var_572.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_572.window);
            var_572.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1474);
         var_572 = _loc5_;
      ...
      {
         return var_572.dispatchWidgetEvent(param1);
      }
