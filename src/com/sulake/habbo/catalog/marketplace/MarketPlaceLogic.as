package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1644:int = 3;
      
      public const const_1591:int = 2;
      ...
      private var var_2182:MarketplaceItemStats;
      ...
      {
         if(param1.furniCategoryId != var_1994 || param1.furniTypeId != var_1993)
         {
            return;
         }
         var_2182 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1591,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_391)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1618 = _loc3_.creditsWaiting;
         var_200 = new Map();
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_187)
         {
            var_187 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_187.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_2180,var_2181,var_1627,var_2183);
      }
