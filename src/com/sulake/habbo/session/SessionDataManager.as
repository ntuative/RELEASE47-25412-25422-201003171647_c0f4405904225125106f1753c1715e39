package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1514:UserTagManager;
      ...
      private var var_1513:GroupDetailsView;
      
      private var _name:String;
      
      private var var_486:int = 0;
      
      private var var_1048:FurnitureDataParser;
      ...
      private var var_1047:HabboGroupInfoManager;
      
      private var var_970:String;
      
      private var var_2043:Boolean;
      
      private var var_1049:ProductDataParser;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_706 = [];
         var_1514 = new UserTagManager(events);
         var_1047 = new HabboGroupInfoManager(this,events);
      ...
      {
         var_1049.removeEventListener(ProductDataParser.READY,onProductsReady);
         var_1049 = null;
         var_587 = new Map();
         var_514 = new Map();
         var_414 = new Map();
         ...
         var_1048 = new FurnitureDataParser(_loc2_,var_587,var_514,var_414,_localization);
         var_1048.addEventListener(FurnitureDataParser.READY,onFurnitureReady);
      }
      
      public function getUserTags(param1:int) : Array
      {
         return var_1514.getTags(param1);
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var _loc3_:String = var_152.getKey("external.hash");
         _loc2_ = _loc2_.replace("%hash%",_loc3_);
         var_1049 = new ProductDataParser(_loc2_,var_815);
         var_1049.addEventListener(ProductDataParser.READY,onProductsReady);
      }
      ...
      {
         return var_1047.getBadgeId(param1);
      }
      ...
      {
         return var_1275.getBadgeImage(param1,BadgeImageManager.const_960);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         _id = _loc3_.id;
         _name = _loc3_.name;
         var_1823 = _loc3_.respectTotal;
         var_861 = _loc3_.respectLeft;
         var_486 = _loc3_.petRespectLeft;
         var_610 = _loc3_.figure;
         var_970 = _loc3_.sex;
      ...
      {
         return var_1047.getGroupDetails(param1);
      }
      ...
      public function getFloorItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getFloorItemData(parseInt(var_414.getValue(param1)));
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         var_2042 = _loc2_.isOpen;
         var_2043 = _loc2_.onShutDown;
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         if(var_1513 == null)
         {
            var_1513 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = var_1047.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            var_1513.showGroupDetails(param1);
         }
      }
      
      private function onFurnitureReady(param1:Event = null) : void
      {
         var_1048.removeEventListener(FurnitureDataParser.READY,onFurnitureReady);
         var_1048 = null;
      }
      ...
      {
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(param1 < 0 || var_486 < 1 || _loc2_ == null)
         {
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            var_610 = _loc2_.figure;
            var_970 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(_id,var_610));
         }
      }
      ...
      public function hasUserRight(param1:String) : Boolean
      {
         ...
         return var_706.indexOf(param1) >= 0;
      }
      ...
      public function getWallItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getWallItemData(parseInt(var_414.getValue(param1)));
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_1514.communication = _communication;
         var_1047.communication = _communication;
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return var_587.getValue(param1.toString());
      }
      ...
      public function get isAnyRoomController() : Boolean
      {
         ...
         return var_706.indexOf("fuse_any_room_controller") >= 0;
      }
      ...
      public function getWallItemData(param1:int) : IFurnitureData
      {
         ...
         return var_514.getValue(param1.toString());
      }
      ...
      private function initBadgeImageManager() : void
      {
         ...
         var_1275 = new BadgeImageManager(_loc1_,events,var_152,_localization);
      }
