package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      {
         if(var_35 == RoomSessionEvent.const_308 && _connection != null)
         {
            var_35 = RoomSessionEvent.const_94;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1020 as IUserDataManager;
      }
