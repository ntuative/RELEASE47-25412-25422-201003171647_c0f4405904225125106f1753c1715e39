package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1170:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_960:String = "group_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1170:
               if(var_152 != null)
               {
                  _loc5_ = var_152.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_960:
               if(var_152 != null)
               {
                  if(var_152 != null)
                  {
                     _loc5_ = var_152.getKey("group.badge.url");
