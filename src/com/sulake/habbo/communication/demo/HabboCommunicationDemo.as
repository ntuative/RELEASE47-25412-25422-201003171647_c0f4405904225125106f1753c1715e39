package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1883:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1463:ILogger;
      ...
      private var var_395:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1350:
            case DisconnectReasonEvent.const_1174:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1302:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1312:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1885)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1200,var_1884));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_395.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_395.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1883);
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1200 = _habboConfiguration.getKey("flash.client.url","");
         var_1884 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_169 == null)
         {
         ...
         if(var_678 != null)
         {
            var_65.mode = HabboConnectionType.const_374;
            var_65.initConnection(HabboConnectionType.const_237);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1463 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_587);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1883 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_65.mode)
         {
            case HabboConnectionType.const_374:
               _loc6_ = "";
               ...
               var_1006 = _loc4_;
               var_169.loadBannerImage(_loc7_ + "?token=" + var_1006,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_854:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1278:
               var_570 = generateRandomHexString(30);
               var_395 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_395.init(var_570);
               _loc8_ = var_395.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1006);
         ...
         var_395 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_395.init(_loc14_);
            _loc15_ = var_395.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_65.mode = HabboConnectionType.const_854;
            }
         }
         var_65.initConnection(HabboConnectionType.const_237);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_195);
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_103,onRoomSessionEnded);
      }
