   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_919,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_601,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_352,onHelpTutorialEvent);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_99,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_601,onFigureUpdate);
         ...
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_989,onAvatarEffectsChanged);
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_824,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_352,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_99,onHelpTutorialEvent);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_99:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_99));
               break;
            case HabboHelpTutorialEvent.const_352:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_541);
         _loc1_.push(RoomWidgetDanceMessage.const_688);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_523);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_648);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_613);
         _loc1_.push(RoomWidgetStopEffectMessage.const_509);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1390);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_797);
         _loc1_.push(RoomWidgetToolbarMessage.const_567);
         _loc1_.push(RoomWidgetToolbarMessage.const_612);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_570);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1217);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_884);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_666);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_625);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_716);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_581);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1303);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_698);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_572);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_638);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_584));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_625:
               ...
               break;
            case RoomWidgetWaveMessage.const_541:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_688:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_523:
               if(var_10 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_613:
               ...
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_680)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_239,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_648:
               ...
               if(var_10 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_829:
                        _catalog.openCatalogPage(CatalogPageName.const_1359,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_830:
            ...
            case RoomWidgetStopEffectMessage.const_509:
            ...
            case RoomWidgetNavigateToRoomMessage.const_797:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_666:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_567:
               ...
               break;
            case RoomWidgetToolbarMessage.const_612:
               ...
               if(var_189 && false)
               {
                  var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_415,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_570:
               ...
               if(_container)
               {
                  ...
                  if(false && _loc23_ == HabboClubLevelEnum.const_74)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_467,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_964));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_467,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1308));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_530));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_716:
            ...
            case RoomWidgetGetSettingsMessage.const_581:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_698:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_324,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_572:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_324,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_638:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_676));
               }
               break;
            default:
