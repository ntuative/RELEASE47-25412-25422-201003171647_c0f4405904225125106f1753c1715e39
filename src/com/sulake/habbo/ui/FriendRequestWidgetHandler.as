package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_516);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_683);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_548);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case FriendRequestEvent.const_249:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_516:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_683:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_548:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_249);
         return _loc1_;
      }
