package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_559);
         _loc1_.push(RoomWidgetChatTypingMessage.const_563);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_559:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_563:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_734,HabboToolbarIconEnum.CHATINPUT,param1));
