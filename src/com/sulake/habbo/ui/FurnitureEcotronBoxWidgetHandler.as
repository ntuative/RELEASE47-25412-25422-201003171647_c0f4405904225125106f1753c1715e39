package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_531,RoomWidgetEcotronBoxOpenMessage.const_707,RoomWidgetEcotronBoxOpenedMessage.const_1363];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_531:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_707:
