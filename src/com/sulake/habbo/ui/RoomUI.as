package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_251:IAdManager;
      
      private var var_803:IRoomWidgetFactory;
      ...
      private var var_548:IAvatarRenderManager;
      ...
      private var var_333:ISessionDataManager;
      ...
      {
         var_1004 = RoomDesktop.const_353;
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_465 = param2 as IHabboSoundManager;
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_103:
               if(param1.session != null)
               {
                  ...
                  var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_161,HabboToolbarIconEnum.ZOOM));
                  var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_161,HabboToolbarIconEnum.MEMENU));
                  var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_161,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            var_251.events.addEventListener(AdEvent.const_463,method_5);
            var_251.events.addEventListener(AdEvent.const_480,method_5);
            var_251.events.addEventListener(AdEvent.const_373,method_5);
         }
      }
      
      private function method_5(param1:AdEvent) : void
      {
         if(param1 == null)
         {
            return;
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_803 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_803 != null)
         {
            var_803.release(new IIDHabboRoomWidget());
            var_803 = null;
         }
         if(var_10 != null)
         {
         ...
         if(var_465 != null)
         {
            var_465.release(new IIDHabboSoundManager());
            var_465 = null;
         }
         if(var_251 != null)
         {
         ...
         if(var_548 != null)
         {
            var_548.release(new IIDAvatarRenderManager());
            var_548 = null;
         }
         if(_catalog != null)
         {
         ...
         if(var_333 != null)
         {
            var_333.release(new IIDSessionDataManager());
            var_333 = null;
         }
         var_1196 = null;
         _connection = null;
         if(var_252)
         {
            while(false)
            {
               _loc1_ = var_252.getKey(0) as String;
               _loc2_ = var_252.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = var_252.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_254);
            if(_loc3_ != RoomDesktop.const_353)
            {
               var_1004 = _loc3_;
            }
            _loc2_.dispose();
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_333 = param2 as ISessionDataManager;
      }
      ...
      public function update(param1:uint) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < var_252.length)
         {
            _loc3_ = var_252.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_684:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_254);
               if(var_1004 != RoomDesktop.const_353)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_254,var_1004);
               }
               if(var_251 != null)
               {
                  var_251.showRoomAd();
            ...
            case RoomEngineEvent.const_668:
               ...
               break;
            case RoomEngineRoomColorEvent.const_544:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_650,roomEngineEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_544,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_561,roomObjectEventHandler);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_548 = param2 as IAvatarRenderManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(var_19)
         {
            ...
            var_19.events.addEventListener(RoomSessionEvent.const_94,roomSessionStateEventHandler);
            var_19.events.addEventListener(RoomSessionEvent.const_103,roomSessionStateEventHandler);
            var_19.events.addEventListener(RoomSessionChatEvent.const_153,roomSessionEventHandler);
            ...
            var_19.events.addEventListener(RoomSessionPresentEvent.const_259,roomSessionEventHandler);
            ...
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_704,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_790,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_793,roomSessionDialogEventHandler);
            ...
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_643,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_609,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_175,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_689,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_722,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionQueueEvent.const_412,roomSessionEventHandler);
            var_19.events.addEventListener(RoomSessionVoteEvent.const_131,roomSessionEventHandler);
            ...
            var_19.events.addEventListener(RoomSessionDimmerPresetsEvent.const_443,roomSessionEventHandler);
            var_19.events.addEventListener(RoomSessionFriendRequestEvent.const_123,roomSessionEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_650)
         {
            if(var_19 != null)
            {
               var_19.roomEngineReady = true;
      ...
      {
         return var_252.getValue(param1) as RoomDesktop;
      }
