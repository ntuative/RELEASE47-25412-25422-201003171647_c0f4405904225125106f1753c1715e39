package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_627,RoomWidgetPresentOpenMessage.const_672,RoomWidgetPresentOpenedMessage.const_1340];
      }
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_77:
                           ...
                           else if(_loc3_ != null && _loc3_.name == const_186)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_426,0,_container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                        ...
                        case ProductTypeEnum.const_371:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_398,0,_container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_627:
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_672:
