package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_30:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_512);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_840);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_962);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_338)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_951)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_654);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_201)
               {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_838;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_997;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1169);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_560.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_52);
            var_560.add(_loc2_.petId,_loc5_);
         }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_515);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_589);
         _loc1_.push(RoomWidgetFurniActionMessage.const_637);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_502);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_720);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1381);
         _loc1_.push(RoomWidgetPetCommandMessage.const_545);
         _loc1_.push(RoomWidgetPetCommandMessage.const_595);
         _loc1_.push(RoomWidgetUserActionMessage.const_713);
         _loc1_.push(RoomWidgetUserActionMessage.const_418);
         return _loc1_;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_560 != null)
         {
            _loc1_ = var_560.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_560.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_591:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_839,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_660:
               ...
               break;
            case RoomWidgetUserActionMessage.const_515:
            ...
            case RoomWidgetUserActionMessage.const_633:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_589:
            ...
            case RoomWidgetRoomTagSearchMessage.const_502:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_720:
