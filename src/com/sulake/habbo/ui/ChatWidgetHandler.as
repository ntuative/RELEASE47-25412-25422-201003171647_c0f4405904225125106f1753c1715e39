package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomSessionChatEvent.const_153];
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_522.length)
            {
               _loc2_ = var_522.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_153:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_522.getValue(_loc15_) as BitmapData;
                           ...
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_338:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_105);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_105);
                                       if(_loc16_ != null)
                                       {
      ...
      {
         return [RoomWidgetChatMessage.const_640,RoomWidgetChatSelectAvatarMessage.const_547];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_640:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_153,_container.roomSession,0,"Version 25412-25422-201003171556");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_547:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_914 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_914);
            }
            if(var_521 == null)
            {
               var_523.x = 0;
               var_523.y = 0;
               var_523.z = 0;
               var_521 = _loc4_.getScreenPoint(var_523);
               var_914 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_523.x = 0;
            var_523.y = 0;
            var_523.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_523);
            if(_loc8_ != null)
            {
      ...
      {
         return RoomWidgetEnum.const_307;
      }
