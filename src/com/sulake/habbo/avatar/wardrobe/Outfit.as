package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var_1406 = var_12.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_105);
         var_1406.setDirection(AvatarSetType.const_39,int(FigureData.const_789));
         _image = var_1406.getImage(AvatarSetType.const_39);
         _view.udpate(_image);
      }
