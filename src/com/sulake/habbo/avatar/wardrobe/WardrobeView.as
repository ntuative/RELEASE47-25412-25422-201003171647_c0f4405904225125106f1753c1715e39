package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_600:IItemListWindow;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_893:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_600 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_893 = _window.findChildByName("selector") as IItemListWindow;
         var_1545 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  _model.controller.catalog.openCatalogPage(CatalogPageName.const_239,true);
            }
         }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in var_601)
         {
            var_893.removeListItem(_loc1_.window);
            _loc1_.dispose();
         }
         var_601 = [];
         while(true)
         {
            ...
            var_893.addListItem(_loc1_.window);
      ...
      public function updateHotLooks() : void
      {
         ...
         for each(_loc3_ in _model.hotLooks)
         {
            ...
            {
               var_600.addListItem(_loc3_.view.window);
      ...
      private function myLooksSelectorEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_893.getListItemIndex(param2);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_894 * 8 + var_600.getListItemIndex(param2.parent);
