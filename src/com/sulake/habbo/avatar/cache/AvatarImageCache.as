package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc17_ = var_73.getAnimation(_loc5_.definition.state + "." + _loc5_.actionParameter);
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_569)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_457)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_73.getParts(param1,(var_801 as AvatarImage).getFigure(),_loc6_,var_1256,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_73.getCanvas(var_203,var_1256);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1242[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.include || _loc32_ == AvatarAction.const_673) && (_loc6_ == AvatarBodyPartType.const_288 || _loc6_ == AvatarBodyPartType.const_1194 || _loc6_ == AvatarBodyPartType.const_1305) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_203 == AvatarScaleType.const_52)
            {
               _loc30_.x += 67;
            }
            else
