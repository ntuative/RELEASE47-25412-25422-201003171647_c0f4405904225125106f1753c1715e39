package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_34["null"] = new AvatarEditorGridView(param1,FigureData.const_125,param2,param3);
         var_34["null"] = new AvatarEditorGridView(param1,FigureData.const_146,param2,param3);
         var_34["null"] = new AvatarEditorGridView(param1,FigureData.const_150,param2,param3);
         var_34["null"] = new AvatarEditorGridView(param1,FigureData.const_154,param2,param3);
         var_34["null"] = new AvatarEditorGridView(param1,FigureData.const_156,param2,param3);
