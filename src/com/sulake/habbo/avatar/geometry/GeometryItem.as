package com.sulake.habbo.avatar.geometry
{
   public class GeometryItem extends Node3D
   {
      ...
      private var var_502:Vector3D;
      
      private var var_1285:Number;
      ...
      public function GeometryItem(param1:XML, param2:Boolean = false)
      {
         ...
         var_1285 = parseFloat(param1.@radius);
         var_502 = new Vector3D(parseFloat(param1.@nx),parseFloat(param1.@ny),parseFloat(param1.@nz));
         var_2054 = parseInt(param1.@double) as Boolean;
         var_2055 = param2;
      }
      ...
      {
         var _loc2_:Number = Math.abs(param1.z - this.transformedLocation.z - var_1285);
         var _loc3_:Number = Math.abs(param1.z - this.transformedLocation.z + var_1285);
