   ...
   public class CategoryBaseView
   {
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_2260);
      ...
      protected function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_34[var_288];
         if(_loc2_ == null)
         {
            return;
         }
