package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1114:String = AvatarSetType.const_39;
      
      private static const const_1115:String = "Default";
      
      private static const const_1116:int = 125;
       
      
      private var _avatarSubType:int = 0;
      
      private var var_610:AvatarFigureContainer;
      ...
      private var var_519:IAvatarDataContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         if(var_203 == null)
         {
            var_203 = AvatarScaleType.const_52;
         }
         ...
         var_610 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_610.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_1077;
         }
         var_132 = new AvatarImageCache(var_73,this,_assets,var_203);
         setDirection(const_1114,const_1117);
         var_202 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1338;
         if(param2 < AvatarDirectionAngle.const_1208)
         {
            param2 = AvatarDirectionAngle.const_641 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_641)
         {
            param2 -= NaN;
         }
         if(var_674 == AvatarType.PET && param1 == AvatarSetType.const_47)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_73.sortActions(var_202);
         if(_loc1_ == null)
         {
            var_609 = new Array(0,0,0);
         }
         else
         {
            var_609 = var_73.getCanvasOffsets(_loc1_,var_203,var_92);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  var_163 = var_163.concat(_loc3_.spriteData);
                  ...
                  {
                     var_519 = _loc3_.avatarData;
                  }
               }
            }
            if(_loc2_.actionType == AvatarAction.const_673)
            {
               _isAnimating = true;
            }
            if(_loc2_.actionType == AvatarAction.const_402)
            {
               _isAnimating = true;
            }
            if(_loc2_.actionType == AvatarAction.const_410)
            {
               _isAnimating = true;
            }
         }
      ...
      {
         return var_73.getPartColor(var_610,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_73.getCanvas(var_203,var_177.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_73.getBodyParts(param1,var_177.definition,var_92);
         var _loc7_:int = _loc5_.length - 1;
         while(_loc7_ >= 0)
         {
            _loc9_ = _loc5_[_loc7_];
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_518);
            if(_loc10_ != null)
            {
               ...
               if(var_674 == AvatarType.PET)
               {
                  ...
                  _loc17_ = var_73.getParts(_loc9_,var_610,_loc15_,"pet",_loc14_.getDirection(),[]);
                  _loc18_ = 32;
                  if(var_203 == AvatarScaleType.const_105)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_518);
                     _loc21_ = var_92;
                     _loc22_ = 1;
                     switch(var_92)
                     {
                     ...
                     _loc23_ = var_73.getPartActionOffset(getSubType(),var_203,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_73.getCanvas(var_203,var_177.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_73.getBodyParts(param1,var_177.definition,var_92);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_518);
            if(_loc8_ != null)
            {
               ...
               if(var_674 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_73.getParts(_loc7_,var_610,_loc12_,"pet",_loc11_.getDirection(),[]);
                  ...
                  {
                     _loc17_ = _loc14_[0];
                     _loc18_ = _loc17_.getFrameIndex(var_518);
                     _loc19_ = var_92;
                     _loc20_ = 1;
                     switch(var_92)
                     {
                     ...
                     _loc21_ = var_73.getPartActionOffset(getSubType(),var_203,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
         ...
         if(var_519 != null)
         {
            if(false)
            {
               ...
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_519.reds,[],[]);
            }
            else
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_177 = new ActiveActionData(AvatarAction.const_888);
         var_177.definition = var_73.getActionDefinition(const_1115);
      ...
      {
         return var_73.getBodyPartData(param1.animation.id,var_518,param1.id);
      }
            ...
            case AvatarAction.const_518:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1161:
                     if(var_674 == AvatarType.const_81)
                     {
                        if(var_92 == 0)
                        {
