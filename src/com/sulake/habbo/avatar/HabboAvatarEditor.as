package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_549:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_649.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1158)
         {
            ...
            var_461["null"] = new FigureData(this);
            var_461["null"] = new FigureData(this);
            _loc1_ = var_461["null"];
            _loc2_ = var_461["null"];
            ...
            var_15 = new Map();
            var_15.add(AvatarEditorCategory.const_934,new GenericModel(this));
            var_15.add(AvatarEditorCategory.const_47,new HeadModel(this));
            var_15.add(AvatarEditorCategory.const_288,new TorsoModel(this));
            var_15.add(AvatarEditorCategory.const_1310,new LegsModel(this));
            var_15.add(AvatarEditorCategory.const_901,new WardrobeModel(this));
            var_1158 = true;
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_549 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_969 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_969 >= _loc14_.clubLevel))
               {
                  _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1595.clone() as IWindowContainer,param1,_loc14_);
                  _loc4_.push(_loc17_);
                  if(param2 != FigureData.const_59)
                  {
                     _loc18_ = 0;
            ...
            _loc15_ = param2 != FigureData.const_59;
            _loc16_ = Boolean(_loc9_ == "1");
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1149)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_969 >= _loc5_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_15.getValue(AvatarEditorCategory.const_901);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_649.getPalette(param1);
      }
      ...
      {
         var_649 = var_548.getFigureData(AvatarType.const_81);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_548 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_220 == null)
            {
               var_220 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_58,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_220.addChild(_view.window);
               var_220.center();
               var_220.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_934);
         if(var_549 != null)
         {
            var_549.getWardrobe();
         }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_969 = param3;
         var _loc4_:FigureData = var_461[param2];
         if(_loc4_ == null)
         {
            return;
         }
