package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_928:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_2011:IStructureData;
      
      private var var_1506:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1506 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_2011.append(var_1506);
         dispatchEvent(new Event(AvatarStructureDownload.const_928));
      }
   }
}
