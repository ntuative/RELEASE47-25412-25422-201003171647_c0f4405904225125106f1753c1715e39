package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1399:Number = 1;
      
      private var _b:uint;
      
      private var var_1397:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1401,var_1397,var_1399,_alphaMultiplier);
         var_984 = generatePaletteMapForGrayscale(var_1767,var_1766);
      }
      
      public function get reds() : Array
      {
         return var_984.getValue("reds") as Array;
      }
      ...
      {
         return var_984.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_984.getValue("greens") as Array;
      }
      ...
      {
         return var_984.getValue("alphas") as Array;
      }
