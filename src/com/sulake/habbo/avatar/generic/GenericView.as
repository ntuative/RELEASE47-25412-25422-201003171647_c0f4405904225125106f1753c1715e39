package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      public function GenericView(param1:GenericModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_34["null"] = new AvatarEditorGridView(param1,FigureData.const_59,param2,param3);
         ...
         attachImages();
         switchCategory(FigureData.const_59);
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_boy":
                  _model.categorySwitch(FigureData.const_82);
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:AvatarEditorGridView = var_34[var_288];
         if(_loc4_ == null)
         {
            return;
         }
