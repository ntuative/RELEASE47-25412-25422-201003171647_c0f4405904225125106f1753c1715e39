package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return var_1268.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1269.length)
         {
            _loc2_ = var_705.indexOf(var_1269[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_308[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_922 + _loc3_);
                  _loc3_ += var_1270;
               }
            }
            _loc4_++;
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_308[var_705.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_2032.elements("menu");
         var _loc5_:int = 0;
