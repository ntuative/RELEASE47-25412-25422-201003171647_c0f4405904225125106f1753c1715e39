package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_919,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_734,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_937,onHideWindowEvent);
         var_35 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_84));
      }
