package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1097:Number = 90;
      
      private static const const_740:int = 50;
      
      private static const const_1026:Number = 25;
      
      private static const const_1027:int = 50;
      ...
      private var var_941:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_941 = param2;
         var_533 = new Timer(const_1026);
         var_533.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_445.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_445.splice(_loc3_,1);
            var_446.splice(_loc3_,1);
         }
         var_446.push(param1.name);
         var_445.push(param2);
         param1.addEventListener(WindowEvent.const_384,windowEventListener);
         param1.addEventListener(WindowEvent.const_226,windowEventListener);
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_941.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_941.getIconLoc(param1.iconId);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_532[_loc3_] = new Array();
            }
            if(var_532[_loc3_].indexOf(param1) < 0)
            {
               var_532[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_740 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_740 || param1.desktop.height - param1.y < const_1027;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_446[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_532[_loc3_].length)
                  {
                     repositionWindow(var_532[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
