package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_507:String = "LEFT";
      
      private var var_197:IWindowContainer;
      
      private var var_598:Array;
      
      private var var_1540:Number = 15;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_197 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_58,HabboWindowStyle.const_916,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1065 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1065)
         {
         ...
         var_1313 = _loc7_.toolbar.@margin_bottom;
         var_1540 = _loc7_.toolbar.@min_group_margin;
         var_1539 = _loc7_.toolbar.@margin_to_extrabar;
         var_250 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_267,param1,param2,_window,var_250);
         createGroupsFromXmlList(_loc9_,var_598,param1,param2,var_197,var_250);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_139,var_507,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1540,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1313) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1540,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1313) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_598.length)
         {
            _loc3_ = var_598[_loc2_];
            if(_loc3_ != null)
            {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_139,var_507);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_598.length)
         {
            _loc2_ = var_598[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_507);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_139,var_507);
         }
      }
