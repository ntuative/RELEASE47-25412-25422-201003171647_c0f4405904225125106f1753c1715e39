package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1588:int = 255;
      
      private var var_1587:int = 255;
      
      private var var_1363:uint = 16777215;
      
      private var var_1090:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_719:
                  _loc2_.setString(RoomObjectVariableEnum.const_603,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_505:
                  _loc2_.setString(RoomObjectVariableEnum.const_728,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_565:
                  _loc2_.setString(RoomObjectVariableEnum.const_706,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_355:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_220)
                  {
                     _loc8_ = "null";
                  }
                  var_411.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_594:
                  _loc7_ = var_411.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_411.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_844,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_961,int(_loc5_.bgOnly));
            var_1363 = _color;
            var_1588 = var_1131;
            var_1090 = _loc11_;
            var_1587 = _loc12_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         var _loc9_:IVector3d = var_76.method_2(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1283,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1254,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_140 || _loc13_ == RoomPlaneData.const_277)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_923)
         {
            ...
            {
               _loc7_ = var_1363 >> 16 & 255;
               _loc8_ = var_1363 >> 8 & 255;
               _loc9_ = var_1363 & 255;
               _loc10_ = var_1090 >> 16 & 255;
               _loc11_ = var_1090 >> 8 & 255;
               _loc12_ = var_1090 & 255;
               _loc13_ = (_loc2_ - var_923) / var_1586;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1588 + (var_1587 - var_1588) * _loc13_;
               _color = _loc3_;
               var_1131 = _loc4_;
            }
