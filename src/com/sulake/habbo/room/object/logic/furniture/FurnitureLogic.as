   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc4_ != null)
         {
            if(_loc2_ != null)
            {
               _loc2_.setString(RoomObjectVariableEnum.const_950,_loc4_.itemData);
            }
            return;
         }
         var_642 = false;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_328,var_957,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_408,var_958,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_615,var_959,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1133,var_1674,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1269,var_1673,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_980,var_1137,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_678,var_217,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_224,1);
      }
         ...
         switch(param1.type)
         {
            case MouseEvent.ROLL_OVER:
               if(!var_642)
               {
                  ...
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_320,_loc6_,_loc7_));
                  }
                  var_642 = true;
               }
               break;
            ...
            case MouseEvent.DOUBLE_CLICK:
               ...
               if(eventDispatcher != null && _loc9_ != null && _loc9_.indexOf("http") == 0)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_414,_loc6_,_loc7_));
               }
