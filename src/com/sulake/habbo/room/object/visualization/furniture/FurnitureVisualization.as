package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1445:String = null;
      ...
      private var var_1304:Boolean = true;
      ...
      protected var var_2261:Number = NaN;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1445 != null && var_1445.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_900:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_821:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_2132 != param1 || var_2134 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_2133 != param1 || var_2135 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2273 = _loc3_.getNumber(RoomObjectVariableEnum.const_203);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_224));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1445 = _loc3_.getString(RoomObjectVariableEnum.const_313);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_285 != _loc3_.getUpdateID() || param1 != var_206 || param2 != var_2261)
         {
