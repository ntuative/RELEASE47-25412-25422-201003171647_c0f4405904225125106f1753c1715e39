   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2139)
         {
            if(!param1)
            {
               var_266.assign(var_597);
               var_265.assign(var_596);
            }
            else
            {
               var_266.assign(var_597);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_70 == null && var_879 != null || var_266 == null || var_265 == null || var_502 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1307)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1061 || _loc4_.y != var_1999 || _loc4_.z != var_2002 || param1.scale != var_1997))
            {
               var_1061 = _loc4_.x;
               var_1999 = _loc4_.y;
               var_2002 = _loc4_.z;
