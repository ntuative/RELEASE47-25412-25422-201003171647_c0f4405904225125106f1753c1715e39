package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < var_318.length)
         {
            _loc3_ = var_318[param1] as AnimationFrame;
            if(_loc3_ != null)
            {
               return _loc3_.id;
            }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_518 == 0)
         {
            var_518 = _animationData.getStartFrame(var_1085,param1);
         }
         var_518 += 1;
         ...
         {
            _loc5_ = null;
            if(_loc4_ < var_318.length)
            {
               _loc5_ = var_318[_loc4_] as AnimationFrame;
            }
            ...
            if(_loc5_ == null || _loc5_.remainingFrameRepeats >= 0 && _loc7_ <= 0)
            {
               ...
               if(_loc6_ == AnimationFrame.const_805)
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_1085,var_518,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_1085,_loc6_,_loc5_.activeSequenceOffset + 1,var_518,param1);
               }
               var_318[_loc4_] = _loc5_;
               if(_loc5_ != null)
               {
                  _loc3_ = true;
               }
