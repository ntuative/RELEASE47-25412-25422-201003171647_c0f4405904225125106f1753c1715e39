package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_487 = var_262.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_487 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_262 != null)
         {
            ...
            {
               _loc1_ = var_262.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_262.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_262.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
