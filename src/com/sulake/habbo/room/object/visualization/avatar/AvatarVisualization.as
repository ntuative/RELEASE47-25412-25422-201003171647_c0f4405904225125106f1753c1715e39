package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1103:int = 3;
      
      private const const_1634:int = 2;
      
      private var var_872:AvatarVisualizationData = null;
      
      private const const_1104:int = 3;
      ...
      {
         var_872 = param1 as AvatarVisualizationData;
         createSprites(const_1104);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_432.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_513);
         ...
         var _loc14_:Number = _loc8_ - var_1295;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_305);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_285 != _loc3_.getUpdateID() || var_206 != param1.scale || var_160 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_491 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_491;
            ...
            if(var_610 != _loc7_)
            {
               for each(_loc49_ in var_432.getKeys())
               {
                  var_432.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_872.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_432.remove(_loc5_);
               var_432.add(_loc5_,_loc6_);
               var_610 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_321);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_275) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_275);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_575);
            _loc6_.appendAction(AvatarAction.const_518,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_455);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_52)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_378);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_331,AvatarAction.const_1180[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_975);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_974,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_912);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_990);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_911,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_654);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_696);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_876,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_814);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_870,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_410);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_361) > 0;
            if(_loc35_ || _loc13_)
            {
            ...
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_402);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_847);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_542,_loc36_);
            }
            ...
            _loc43_ = getSprite(const_1634);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_921))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_872.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_873.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_873)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_432 != null)
         {
            _loc1_ = var_432.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_432.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
