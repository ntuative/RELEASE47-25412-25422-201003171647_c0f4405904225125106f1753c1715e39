package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_738:String = "HabboNavigatorCom_model_w_png";
      ...
      private var var_757:IGraphicAssetCollection = null;
      
      private var var_102:Map = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = var_757.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
      ...
      {
         return var_300.getValue(param1) as PlaneMaterial;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_102 != null)
         {
            ...
            {
               _loc2_ = var_102.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function resetMaterials() : void
      {
         ...
         {
            _loc2_ = var_300.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return var_102.getValue(param1);
      }
      ...
      public function clearCache() : void
      {
         ...
         while(_loc1_ < var_300.length)
         {
            _loc3_ = var_300.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
