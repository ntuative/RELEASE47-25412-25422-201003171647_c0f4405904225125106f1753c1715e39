package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1240:int = 13421772;
      
      private static const const_1080:int = 16777215;
      
      public static const const_1265:int = 10066329;
      ...
      public static const const_1233:int = 16777215;
      ...
      private var var_1974:int = -1000;
      
      private var var_1033:uint = 16777215;
      ...
      private var var_583:Rectangle = null;
      
      private var var_2000:int = 255;
      
      private var var_1965:Boolean = false;
      
      private var var_1995:int = 255;
      
      private var var_2001:String = null;
      ...
      private var var_411:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_411 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_943);
         var _loc7_:int = 0;
         while(_loc7_ < var_76.planeCount)
         {
            _loc8_ = var_76.getPlaneLocation(_loc7_);
            _loc9_ = var_76.method_2(_loc7_);
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_265,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_186,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < var_102.length)
            {
               _loc4_ = var_102[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_265 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_583 == null)
         {
            var_583 = super.boundingRectangle;
         }
         return new Rectangle(var_583.x,var_583.y,var_583.width,var_583.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_411.maskCount)
         {
            _loc6_ = var_411.getMaskType(_loc5_);
            _loc7_ = var_411.getMaskLocation(_loc5_);
            _loc8_ = var_411.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_102.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_265 || _loc3_.type == RoomPlane.const_186 && _loc8_ == RoomPlaneBitmapMaskData.const_220)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1488;
                        if(var_76.getPlaneType(_loc9_) == RoomPlaneData.const_144)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1307)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1061 || _loc9_.y != var_1999 || _loc9_.z != var_2002 || param1.scale != var_1997))
            {
               var_1061 = _loc9_.x;
               var_1999 = _loc9_.y;
               var_2002 = _loc9_.z;
               var_1997 = param1.scale;
               _loc4_ = true;
            }
         }
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_844);
            if(_loc10_ != var_2001)
            {
            ...
            {
               var_1033 = _loc11_;
               var_1995 = var_1033 & 255;
               var_2000 = var_1033 >> 8 & 255;
               var_1996 = var_1033 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1974 + const_1631 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1974 = _loc7_;
         if(var_160 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_728);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_603);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_706);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1998 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_961));
         ...
         while(_loc8_ < var_410.length)
         {
            ...
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_186)
            {
               if(var_1998)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1995 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_2000 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1996 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_102.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_265 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               else if(_loc5_.type == RoomPlane.const_186 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
