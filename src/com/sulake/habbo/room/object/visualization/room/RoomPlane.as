package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_186:int = 3;
      ...
      private var var_879:Vector3d = null;
      ...
      private var var_538:PlaneMaskManager = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         super();
         var_2158 = param8;
         var_879 = new Vector3d();
         var_879.assign(param1);
         var_70 = new Vector3d();
         ...
         var_502 = Vector3d.crossProduct(var_266,var_265);
         if(false)
         {
            var_502.mul(Infinity);
         }
         if(param7 != null)
         {
            _loc13_ = 0;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_265 || _type == const_186))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_898 || false && false && !var_156 || var_538 == null)
         {
            return;
         }
         ...
         if(var_156)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_502);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_199.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_538.updateMask(var_58,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_726.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_269.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1071.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_156 = false;
      ...
      {
         if(var_137 == null || var_104 == null || var_78 == null || var_103 == null || param2 == null || _bitmapData == null)
         {
            return;
         }
         ...
         if(_type == const_265 || _type == const_186)
         {
      ...
      private function updateCorners(param1:IRoomGeometry) : void
      {
         ...
         var_104.assign(param1.getScreenPosition(Vector3d.sum(var_70,var_265)));
         var_78.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(var_70,var_266),var_265)));
         var_103.assign(param1.getScreenPosition(Vector3d.sum(var_70,var_266)));
         _offset = param1.getScreenPoint(var_879);
         ...
         var _loc2_:Number = Math.min(var_137.x,var_104.x,var_78.x,var_103.x);
         var _loc3_:Number = Math.max(var_137.x,var_104.x,var_78.x,var_103.x);
         var _loc4_:Number = Math.min(var_137.y,var_104.y,var_78.y,var_103.y);
         var _loc5_:Number = Math.max(var_137.y,var_104.y,var_78.y,var_103.y);
         _loc3_ -= _loc2_;
         _offset.x = 0 - _loc2_;
         var_137.x = 0 - _loc2_;
         var_104.x = 0 - _loc2_;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            while(_loc1_ < var_199.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < var_726.length)
                  {
                     _loc7_ = var_726[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1174.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1174[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
            ...
            _loc6_ = param1.getScreenPosition(var_879);
            _loc7_ = _loc6_.z;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            _loc7_ = param1.getCoordinatePosition(var_502);
            _loc4_ = getTextureIdentifier(param1.scale);
            if(var_235 != null)
            {
               _loc3_ = var_235;
            ...
            if(var_727 != null)
            {
               _loc3_ = var_727.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1550,var_2159,var_2156,var_2160,var_2157,param2);
               if(_loc3_ != null)
               {
