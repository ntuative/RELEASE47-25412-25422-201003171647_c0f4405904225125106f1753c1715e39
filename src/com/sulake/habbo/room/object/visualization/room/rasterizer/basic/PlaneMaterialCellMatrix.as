package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1389:int = const_300;
      ...
      public static const const_207:int = 4;
      ...
      private var var_1129:Boolean = true;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1630 = param6;
         var_1629 = param7;
         var_539 = new Vector3d();
         if(_repeatMode == const_604)
         {
            var_1129 = false;
         }
      }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(false)
         {
            _loc4_ = var_330[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1405 == const_102)
         {
            _loc5_ = new Rectangle(0,0,var_25.width,var_329);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_329,var_25.width,var_329);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_25 != null)
            {
               if(var_25.width == param2 && var_25.height == param3 && Vector3d.isEqual(var_539,param4))
               {
                  if(param1 != null)
                  {
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < var_330.length)
         {
            _loc11_ = var_330[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      public function clearCache() : void
      {
         ...
         if(var_539 != null)
         {
            var_539.assign(new Vector3d());
         }
         var_329 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < var_330.length)
         {
            _loc2_ = var_330[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= var_330.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = var_330[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         var_330[param1] = _loc5_;
