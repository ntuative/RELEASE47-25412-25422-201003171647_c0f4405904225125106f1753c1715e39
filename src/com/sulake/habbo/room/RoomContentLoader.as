package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_781:String = "selection_arrow";
      
      private static const const_779:String = "tile_cursor";
      ...
      private static const const_1108:String = const_348;
      ...
      public static const const_558:String = "RCL_LOADER_READY";
      ...
      private var var_1073:IEventDispatcher = null;
      
      private var var_1332:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_516 = [];
         var_514 = [];
         var_2190 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2184 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_429 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_297,_loc4_);
      ...
      {
         if(var_174 != null && var_174.hasWorldType(const_281 + param1))
         {
            return var_174.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_515.add(_loc10_,_loc11_);
                              if(var_516.indexOf(_loc14_) < 0)
                              {
                                 var_516.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_429 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_429.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_429.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_429.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_348,const_496,ROOM_CONTENT,const_779,const_781];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2190.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function method_10(param1:String) : String
      {
         var _loc6_:* = null;
         if(param1 == null)
         {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_162 && _loc5_ != RoomObjectLogicEnum.const_132)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_515.getValue(param1) as String;
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_427 != null)
         {
            _loc2_ = var_427.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1187);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2184.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1332.add(_loc5_,_loc8_);
               var_174 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_297,_loc5_);
         }
         else
         {
      ...
      private function continueInitilization() : void
      {
         if(var_2185)
         {
            ...
            if(var_1073 != null)
            {
               var_1073.dispatchEvent(new Event(const_558));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_174 != null)
         {
            return var_174.getWorldHeightScale(const_281 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1073 = param1;
            var_2189 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2187 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2186 = param2.getKey("public.room.dynamic.download.url","");
            var_2188 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_35 = const_780;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_427 != null)
         {
            var_427.remove(param1);
            var_427.add(param1,param2);
         }
         if(var_428 != null)
         {
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_162 && _loc5_ != RoomObjectVisualizationEnum.const_132)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_407.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_281 + param1) == RoomObjectCategoryEnum.const_64)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1332.getValue(param1) != null)
         {
            var_174 = var_1332.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_483,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_174 != null)
         {
            return var_174.getWorldScale(const_281 + param1);
         }
         return 32;
      }
