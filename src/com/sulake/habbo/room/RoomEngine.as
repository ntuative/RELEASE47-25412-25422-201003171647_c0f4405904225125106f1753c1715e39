package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_278:String = "object_icon_sprite";
      
      private static const const_744:int = -3;
      
      private static const const_742:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1029:String = "tile_cursor";
      
      private static const const_279:int = -1;
       
      
      private var var_407:IRoomObjectVisualizationFactory = null;
      ...
      private var var_631:RoomMessageHandler = null;
      
      private var var_630:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         var_631 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_64 != null)
         {
            ...
            {
               return var_64.deleteWallItem(var_107,var_108,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_605) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_551) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_501) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_533) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_64 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_30)
            {
               return var_64.modifyWallItemData(var_107,var_108,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_407 != null)
         {
            var_407.release(new IIDRoomObjectVisualizationFactory());
            var_407 = null;
         }
         if(var_41 != null)
         {
         ...
         if(var_630 != null)
         {
            var_630.release(new IIDRoomRendererFactory());
            var_630 = null;
         }
         ...
         if(var_251)
         {
            var_251.release(new IIDHabboAdManager());
            var_251 = null;
         }
         _connection = null;
         if(var_534 != null)
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_630.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1016;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_669);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_552);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_687);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_938);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_946);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1008) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_806);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_355,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_549,var_107,var_108,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_64 != null)
         {
            return var_64.modifyRoomObject(var_107,var_108,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_290.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_290.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_719,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_505,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_565,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_41 != null)
         {
            ...
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_36);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_64);
            var_41.setContentLoader(var_11);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_64 != null)
         {
            var_64.handleRoomObjectEvent(param1,var_107,var_108);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_203,_loc12_,true);
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_840,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_962,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_264,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
      ...
      {
         if(var_28 == null || var_407 == null || var_41 == null || var_630 == null || _communication == null || _habboConfiguration == null || !var_1614)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_279,RoomObjectCategoryEnum.const_64);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1361,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_41.getRoom(getRoomIdentifier(var_107,var_108));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_744,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_107,var_108,var_1115);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_278);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_107,var_108,var_1115);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_278);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_407 = param2 as IRoomObjectVisualizationFactory;
         if(var_11 != null)
         {
            var_11.visualizationFactory = var_407;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_28 != null)
         {
            if(false)
            {
               var_28.events.addEventListener(RoomObjectMouseEvent.const_193,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.const_400,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_252,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_610,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_110,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_360,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_379,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_401,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_388,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_395,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_396,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_464,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_62,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_432,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_430,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_273,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_414,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_320,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_325,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_481,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_809,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_416,roomObjectEventHandler);
               var_28.events.addEventListener(AvatarWalkWarpingWarningEvent.const_393,warningEventHandler);
            }
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_223;
      }
      
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         var _loc5_:IRoomInstance = getRoom(var_107,var_108);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_631) != 0)
         {
            return false;
         }
         if(var_64 != null)
         {
            return var_64.initializeRoomObjectInsert(var_107,var_108,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_447 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_650,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_290.length)
            {
               _loc3_ = var_290.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_264,param1,param2,param3,RoomObjectCategoryEnum.const_36));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_30:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_203));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_387);
                     break;
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_321);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_558)
         {
            var_1614 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_203,_loc10_,false);
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1016,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_264,param1,param2,param3,RoomObjectCategoryEnum.const_30));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_251 = param2 as IAdManager;
         var_251.events.addEventListener(AdEvent.const_373,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_742) as Sprite;
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_630 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_447 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_41.getRoom(const_485);
         if(_loc10_ == null)
         {
            _loc10_ = var_41.createRoom(const_485,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_31:
            case RoomObjectCategoryEnum.const_30:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_203,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_387,param8);
               break;
            case RoomObjectCategoryEnum.const_36:
            ...
            case RoomObjectCategoryEnum.const_64:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_603,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_728,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_706,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_355,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_943.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_871,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_743,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_107,var_108,param1);
         if(_loc9_ != null)
         {
            var_1115 = param1;
            var_1391 = param2;
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_278);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1391 - _loc12_.width / 2;
               _loc11_.y = var_1390 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_434,var_107,var_108,-1,RoomObjectCategoryEnum.const_223));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_64 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_279,const_486);
                  var_64.handleRoomObjectEvent(_loc14_,var_107,var_108);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_107,var_108,param1,param2,new Vector3d(),1,null);
         }
         else if(var_11 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_107,var_108,var_1115);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_278);
            _loc11_ = addOverlayIconSprite(_loc10_,const_278,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1391 - _loc6_.data.width / 2;
               _loc11_.y = var_1390 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_301,param1.image,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_941,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_850,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1001,RoomObjectVariableEnum.const_301,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_11 != null)
         {
            _events.addEventListener(RoomContentLoader.const_558,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_64 != null)
         {
            var_64.cancelRoomObjectInsert(var_107,var_108);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_41.getRoom(const_485);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_871);
               ...
               _loc13_ = var_943.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_107,var_108,const_279,RoomObjectCategoryEnum.const_64,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1003,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_631,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_875,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_279,const_486,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_631,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_669,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_605,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_501,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_551,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_533,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_943,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_719,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_505,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_565,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_355,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_220);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_552,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_687,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_552,_loc25_,true);
                        ...
                        _loc7_.setNumber(RoomObjectVariableEnum.const_946,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_743,const_1029,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_744,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }
