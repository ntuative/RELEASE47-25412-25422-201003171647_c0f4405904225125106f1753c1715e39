package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1911:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25412-25422-201003171556");
         var_189 = param5;
         var_99 = new Map();
         var_99.add(HabboHelpViewEnum.const_1160,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_145,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_433,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_251,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_229,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_724,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_312,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_598,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_228,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_99.add(HabboHelpViewEnum.const_993,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_99.add(HabboHelpViewEnum.const_667,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         if(var_396 == null)
         {
            ...
            var_396 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_396 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_396 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_396 as IWindow);
      ...
      {
         var_1909 = param1;
         var _loc2_:IHelpViewController = var_99.getValue(HabboHelpViewEnum.const_145) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_228:
               ...
               break;
            case CallForHelpResultEnum.const_846:
               showUI(HabboHelpViewEnum.const_993);
               break;
      ...
      private function setBackButtonActiveState(param1:Boolean = false) : void
      {
         ...
         if(true)
         {
            ...
            var_575.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_575.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_396.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_575[1],var_575[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_575[0],var_575[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1477;
         _window.width = _loc1_.width + var_1476;
      }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_24.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_507));
      }
