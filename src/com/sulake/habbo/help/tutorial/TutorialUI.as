package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_276:String = "TUI_NAME_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         ...
         _main.events.addEventListener(HabboHelpTutorialEvent.const_530,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_676,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         _main.hideUI();
         _main.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_99));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_1018 = true;
         if(var_31 != null && (var_31.id == const_276 || var_31.id == const_85))
         {
            showView(const_85);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1477;
         _window.width = _loc2_.width + var_1476;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_507:
               var_1017 = true;
               if(var_31 != null && var_31.id == const_437)
               {
                  showView(const_85);
               }
               break;
            case HabboHelpTutorialEvent.const_530:
               if(var_31 != null && var_31.id == const_335)
               {
                  var_1216 = true;
                  disposeWindow();
               }
      ...
      {
         var_1016 = true;
         if(var_31 != null && (var_31.id == const_335 || var_31.id == const_85))
         {
            showView(const_85);
         }
      }
      ...
      {
         return var_1016 && var_1018 && var_1017;
      }
   }
}
