package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_2128:uint = 11129827;
      ...
      private var var_263:IBorderWindow;
      
      private var var_875:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_416);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_416);
         }
         if(var_263 == null)
         {
            var_263 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_263 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_263);
            var_263.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_263.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_1596:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1594:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1594 || param1 == ChangeUserNameResultMessageEvent.var_1596)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_875 = new NameSuggestionListRenderer(_main);
         var _loc6_:int = var_875.render(param3,_loc5_);
         var _loc7_:int = 0;
