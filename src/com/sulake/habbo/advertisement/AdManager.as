   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_373,0,0,_loc4_,var_1439,var_787,var_788));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1785 = int(_config.getKey("interstitial.interval","30000"));
         var_1784 = int(_config.getKey("interstitial.show.time","5000"));
         var_1440 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1179 = _loc2_.imageUrl;
         var_1439 = _loc2_.clickUrl;
         if(var_1179 != "" && var_1439 != "")
         {
            _loc3_ = var_1179;
            ...
            _loc4_ = new URLRequest(var_1179);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1178 = _loc2_.imageUrl;
         var_1786 = _loc2_.clickUrl;
         var_661 = getTimer();
         if(var_1178 != "")
         {
            _loc3_ = var_1178;
            ...
            var_222.start();
            _loc4_ = new URLRequest(var_1178);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_480,0,0,param1.bitmapData,var_1786));
            var_661 = getTimer();
         }
         else
         {
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1440 > 0 && var_1441 >= var_1440)
         {
            return false;
         }
