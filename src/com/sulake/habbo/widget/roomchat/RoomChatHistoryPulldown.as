package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_39 = param3;
         var_2112 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1529 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_2117 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1530 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1528 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_2113 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_2114 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_72 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_38,HabboWindowParam.const_71,new Rectangle(0,0,param3.width,param3.height - const_75),null,0,0) as IBitmapWrapperWindow;
         var_39.addChild(var_72);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_58,HabboWindowStyle.const_38,HabboWindowParam.const_40,new Rectangle(0,0 - const_75,param3.width,const_75),null,0) as IWindowContainer;
         var_39.addChild(_window);
         var_96 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_442,HabboWindowStyle.const_41,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_75),null,0) as IRegionWindow;
         if(var_96 != null)
         {
            var_96.background = true;
            var_96.alphaTreshold = 0;
            var_96.addEventListener(WindowMouseEvent.const_51,onPulldownMouseDown);
            var_39.addChild(var_96);
      ...
      public function update(param1:uint) : void
      {
         switch(state)
         {
            case const_380:
               ...
               break;
            case const_778:
               var_72.blend = 0 - param1 / const_773;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(var_96 != null)
         {
            var_96.x = 0;
            var_96.y = 0 - const_75;
            var_96.width = 0 - var_2115;
         }
         if(var_72 != null)
         {
            var_72.rectangle = var_39.rectangle;
            var_72.height = 0 - const_75;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_2116 == _window.width)
         {
            return;
         }
         var_2116 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_2112.clone(),_loc7_);
