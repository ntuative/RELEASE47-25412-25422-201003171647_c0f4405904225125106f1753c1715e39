package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1030:Number = 18;
      ...
      private var var_182:BitmapData;
      
      private var var_953:uint;
      ...
      {
         _widget.onItemMouseOut(var_951,var_952,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_951,var_636,var_952,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1133 = param1.chatType;
         var_951 = param1.userId;
         var_636 = param1.userName;
         var_952 = param1.userCategory;
         _message = param1.text;
         var_1134 = param1.userX;
         var_182 = param1.userImage;
         var_953 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1133)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_263:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_271:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_182 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_182.height);
         }
         ...
         if(var_182 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_182.width;
               _loc28_.height = var_182.height;
               _loc28_.bitmap = new BitmapData(var_182.width,var_182.height,true,0);
               _loc28_.bitmap.copyPixels(var_182,var_182.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_379 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_182.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_953 != 0)
            {
               _loc30_ = uint(var_953 >> 16 & 255);
               _loc31_ = uint(var_953 >> 8 & 255);
               _loc32_ = uint(var_953 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1133 == RoomWidgetChatUpdateEvent.const_263)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_636);
            }
            else if(var_1133 == RoomWidgetChatUpdateEvent.const_271)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_636);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_342 + _loc20_.textWidth + const_488;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_951,var_952,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_951,var_952,_roomId,_roomCategory,param1);
      }
