package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1427:String = "infostand_user_view";
      
      private var var_311:InfoStandPetView;
      
      private var var_1143:InfoStandPetData;
      
      private var var_140:Timer;
      
      private var var_890:InfoStandFurniView;
      ...
      private const const_1426:String = "infostand_bot_view";
      ...
      private var var_391:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_890 = new InfoStandFurniView(this,const_1429);
         var_198 = new InfoStandUserView(this,const_1427);
         var_311 = new InfoStandPetView(this,const_1428);
         var_351 = new InfoStandBotView(this,const_1426);
         var_391 = new InfostandUserData();
         var_430 = new InfostandFurniData();
         var_1143 = new InfoStandPetData();
         var_140 = new Timer(const_1638);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_198.setTags(param1.tags,var_2149);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_227,onClose);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_512,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_508,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_418,var_311.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_227,onClose);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_512,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_508,onBadgeImage);
      ...
      {
         var_311.updateEnabledTrainingCommands(param1.id,param1.enabledCommands);
      }
