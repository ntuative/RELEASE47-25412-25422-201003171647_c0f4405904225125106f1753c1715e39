package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1618:String = "energy";
      
      private var var_1143:Map;
      
      private const const_1610:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1612:uint = 3355443;
      
      private var var_213:IBorderWindow;
      
      private const const_1614:int = 158;
      
      private const const_1613:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_248:PetCommandTool;
      
      private const const_1617:uint = 11184810;
      
      private const const_1616:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_213 != null)
         {
            var_98 = var_213.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_98 == null || var_213 == null || var_60 == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_248 == null)
         {
            var_248 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1143.getValue(var_731) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_248.showWindow(true);
            var_248.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1616,param1.experience,param1.experienceMax);
         updateStateElement(const_1618,param1.energy,param1.energyMax);
         ...
         updateWindow();
         var_731 = param1.id;
         var_1143.remove(param1.id);
         var_1143.add(param1.id,param1);
         if(var_248 && var_248.isVisible() && param1.isOwnPet)
         {
            var_248.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_248.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_474,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1614,const_1613,false);
         ...
         _loc5_.fillRect(_loc6_,const_1612);
