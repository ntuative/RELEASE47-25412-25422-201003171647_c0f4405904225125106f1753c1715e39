package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private var var_791:Timer = null;
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         checkForFlooding();
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_640,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_227,onRoomObjectDeselected);
      ...
      {
         var_1182 = param1.name;
      }
      
      private function onSettings(param1:RoomWidgetChatInputDisplayEvent) : void
      {
         var_1790 = param1.allowPaste;
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_227,onRoomObjectDeselected);
      ...
      private function checkForFlooding() : Boolean
      {
         ...
         if(var_386 > const_1059)
         {
            if(_loc1_ < var_1181 + const_1058)
            {
               var_790 = true;
               var_662 = const_1057 / 1000;
               Logger.log("Enabling flood blocking");
               var_791 = new Timer(1000,var_662);
               var_791.addEventListener(TimerEvent.TIMER,onReleaseTimerTick);
               var_791.addEventListener(TimerEvent.TIMER_COMPLETE,onReleaseTimerComplete);
               var_791.start();
               if(_visualization != null)
               {
                  _visualization.showFloodBlocking(var_662);
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_559,_visualization.window);
         if(messageListener != null)
         {
