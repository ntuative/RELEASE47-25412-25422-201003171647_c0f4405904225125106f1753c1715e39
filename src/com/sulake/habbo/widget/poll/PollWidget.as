package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      private function showPollOffer(param1:Event) : void
      {
         ...
         var _loc3_:PollSession = var_247.getValue(_loc2_) as PollSession;
      ...
      {
         var _loc2_:PollSession = var_247.getValue(param1) as PollSession;
         if(_loc2_)
         {
            _loc2_.showThanks();
            _loc2_.dispose();
            var_247.remove(param1);
         }
      }
      ...
      private function showPollContent(param1:Event) : void
      {
         ...
         {
            _loc3_ = _loc2_.id;
            _loc4_ = var_247.getValue(_loc3_) as PollSession;
            if(_loc4_)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_247)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_247.getWithIndex(0) as PollSession;
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
