package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_261:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_646:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1354:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_35 = const_1354;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_566,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_35 = const_646;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_459,_id));
