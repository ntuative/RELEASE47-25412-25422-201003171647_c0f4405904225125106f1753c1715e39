package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_350:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_58,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1062,const_1063,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            var_350 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      private function method_16() : int
      {
         if(var_216 == null)
         {
            return -1;
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_350 != null)
         {
            var_350.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1062 = _loc2_.light;
         if(var_350 != null)
         {
            var_350.setValue(var_1062);
         }
         var_423 = colors.indexOf(_loc2_.color);
         if(var_503 != null)
         {
            var_503.setSelectedColorIndex(var_423);
         }
