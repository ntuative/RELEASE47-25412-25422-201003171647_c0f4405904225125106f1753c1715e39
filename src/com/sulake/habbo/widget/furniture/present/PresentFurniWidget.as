package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_398,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_436,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_426,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_398,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_436,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_426,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_436:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_426:
               if(!var_232)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_672,var_155);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_58,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1062,const_1063,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_195 != null)
         {
            _loc4_.caption = var_195;
         }
