package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_707,var_155);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_58,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1062,const_1063,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_195 != null)
         {
            _loc6_.caption = var_195;
         }
