package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_680:MeMenuSettingsViewSlider;
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_698);
         }
         else
         {
      ...
      {
         var_681 = param1.volume;
         if(var_680 != null)
         {
            var_680.setValue(var_681);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1470 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = _widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1471 = (_loc5_.content as BitmapData).clone();
         }
         ...
         var_680 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_681 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1470);
               }
               break;
            case "sounds_on":
               if(var_681 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1468);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1469);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1470);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1471);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1468);
