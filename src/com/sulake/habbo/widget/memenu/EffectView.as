package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_915:IWindow;
      
      private var var_916:IWindow;
      ...
      {
         super();
         var_164 = new Timer(1000);
         var_164.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_916 = _window.findChildByName("effect_hilite");
            var_916.visible = false;
         }
         var_917 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_915 = _window.findChildByName("loader_bar");
         if(var_915 != null)
         {
            var_435 = var_915.width;
            var_164.start();
            onUpdate();
         }
         if(false)
      ...
      public function dispose() : void
      {
         ...
         {
            var_164.stop();
            var_164.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_164 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_917 != null)
         {
            var_917.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_917.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
