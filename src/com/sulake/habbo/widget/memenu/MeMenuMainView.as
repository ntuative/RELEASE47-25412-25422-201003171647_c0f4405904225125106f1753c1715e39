      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_892);
               break;
            case "wave":
               if(false)
               {
            ...
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_830));
               _widget.hide();
               break;
            case "clothes":
            ...
            case "hc":
               ...
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_712);
               break;
            case "news":
               if(false && false)
               {
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","com.sulake.habbo.communication.messages.incoming.help") == "true";
               if(false && _loc4_)
               {
