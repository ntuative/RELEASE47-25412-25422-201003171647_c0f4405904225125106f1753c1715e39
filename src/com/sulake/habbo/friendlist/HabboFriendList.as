package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_771:IAvatarRenderManager;
      ...
      private var var_887:FriendRequests;
      
      private var var_2058:int;
      
      var var_15:FriendCategories;
      
      private var var_2147:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_886:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2147 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_15 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1541 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_887.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_887.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_394.findTab(FriendListTab.const_86).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_887 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_15.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_15.addCategory(new FriendCategory(FriendCategory.const_986,getText("friendlist.friends")));
         var_15.addCategory(new FriendCategory(FriendCategory.const_420,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_508)
         {
            var_508 = new Timer(120000);
            var_508.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_508.start();
         }
         getBuddyRequests();
         registerListeners();
         var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_508.stop();
            var_508.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_508 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_128)
         {
            var_128.release(new IIDHabboMessenger());
            var_128 = null;
         }
         if(var_152)
         {
         ...
         if(var_771)
         {
            var_771.release(new IIDAvatarRenderManager());
            var_771 = null;
         }
         if(var_886)
         {
            var_886.release(new IIDHabboNotifications());
            var_886 = null;
         }
         if(var_189)
         {
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_128 = param2 as IHabboMessenger;
      ...
      {
         var _loc1_:String = var_152.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1541.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_887.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:FriendListTab = var_394.findTab(FriendListTab.const_86);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_771.createAvatarImage(param1,AvatarScaleType.const_105);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_887.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_394.findTab(FriendListTab.const_86);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_771 = param2 as IAvatarRenderManager;
      ...
      {
         var_886 = param2 as IHabboNotifications;
      ...
      {
         return var_152.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1542 == null)
         {
            var_1542 = new OpenedToWebPopup(this);
         }
         var_1542.show(x,y);
      }
