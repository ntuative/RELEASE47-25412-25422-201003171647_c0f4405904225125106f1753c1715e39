package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1425:String = "noconvinfo";
      
      private static const const_1424:String = "messageinput";
      ...
      private function prepare() : void
      {
         ...
         var_841 = IWindowContainer(var_14.content.findChildByName("main_content"));
         var_264 = IWindowContainer(var_14.content.findChildByName("footer"));
         var_1316.prepare(var_841);
         var_14.procedure = onWindow;
         var_14.content.setParamFlag(HabboWindowParam.const_971,false);
         var_14.content.setParamFlag(HabboWindowParam.const_1213,true);
         var_14.header.setParamFlag(HabboWindowParam.const_580,false);
         var_14.header.setParamFlag(HabboWindowParam.const_949,true);
         var_14.content.setParamFlag(HabboWindowParam.const_580,false);
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_264.y = Util.getLowestPoint(var_14.content);
         ...
         var_14.scaler.setParamFlag(HabboWindowParam.const_925,this._friendList.tabs.findSelectedTab() != null);
         var_14.scaler.setParamFlag(HabboWindowParam.const_580,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_971,false);
         var_14.scaler.x = 0 - var_14.scaler.width;
         var_14.scaler.y = 0 - var_14.scaler.height;
         var_1544 = var_14.height;
         var_1543 = var_14.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc4_:int = var_1543 == -1 ? 0 : int(0 - var_1543);
