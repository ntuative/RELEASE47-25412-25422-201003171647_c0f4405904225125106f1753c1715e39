package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1488:int = "F".charCodeAt(0);
      
      public static const const_1533:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_970 = param1.gender;
         var_644 = param1.online;
         var_1157 = param1.followingAllowed && param1.online;
         var_610 = param1.figure;
         var_1154 = param1.motto;
         var_1155 = param1.lastAccess;
         var_1116 = param1.categoryId;
