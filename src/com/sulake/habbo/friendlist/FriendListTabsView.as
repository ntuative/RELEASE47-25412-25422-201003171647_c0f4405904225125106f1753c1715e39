package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      private function refreshHeader(param1:FriendListTab, param2:IWindowContainer) : int
      {
         ...
         showBgImage(_loc3_,!param1.newMessageArrived,param1.method_14);
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this._friendList.getXmlWindow(param1.method_15));
