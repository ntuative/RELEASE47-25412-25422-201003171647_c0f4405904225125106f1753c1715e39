package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1521:IMessageComposer;
      ...
      {
         var_799 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         ...
         _main.connection.send(var_1521);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_799.clone());
      ...
      {
         if(param1.type != WindowEvent.const_44 || param2 != var_51)
         {
            return;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = var_1194[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
