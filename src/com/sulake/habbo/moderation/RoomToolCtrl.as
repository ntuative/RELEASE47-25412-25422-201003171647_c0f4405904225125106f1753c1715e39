package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_722:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_597,_data.flatId),var_51,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_722.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1234,_loc2_,var_422.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1068.isSelected,var_1067.isSelected,var_722.isSelected));
         }
         this.dispose();
      }
      ...
      public function populate() : void
      {
         ...
         var_895 = IDropMenuWindow(var_51.findChildByName("msgTemplatesSelect"));
         prepareMsgSelect(var_895);
         var_895.procedure = onSelectTemplate;
         var_722 = ICheckBoxWindow(var_51.findChildByName("kick_check"));
         var_1068 = ICheckBoxWindow(var_51.findChildByName("lock_check"));
         var_1067 = ICheckBoxWindow(var_51.findChildByName("changename_check"));
