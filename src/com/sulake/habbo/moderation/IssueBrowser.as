package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1421:IIssueBrowserView;
      
      private const const_1622:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1621:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1420:IIssueBrowserView;
      
      private const const_1642:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1623:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_216:ITabContextWindow;
      
      private var var_1422:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_332.view.width = var_216.container.width;
         var_332.view.height = var_216.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1623:
               if(var_1420 == null)
               {
                  var_1420 = new MyIssuesView(issueManager,this,var_216.container);
               }
               return var_1420;
            case const_1622:
               if(var_1421 == null)
               {
                  var_1421 = new OpenIssuesView(issueManager,this,var_216.container);
               }
               return var_1421;
            case const_1621:
               if(var_1422 == null)
               {
                  var_1422 = new PickedIssuesView(issueManager,this,var_216.container);
               }
               return var_1422;
            default:
               return null;
