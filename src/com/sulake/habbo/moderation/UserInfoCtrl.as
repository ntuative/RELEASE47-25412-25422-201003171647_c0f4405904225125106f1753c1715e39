package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_755:int = 31536000;
      
      private static const const_752:int = 86400;
      
      private static const const_754:int = 3600;
      
      private static const const_753:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_754)
         {
            return Math.round(param1 / const_753) + " mins ago";
         }
         if(param1 < 2 * const_752)
         {
            return Math.round(param1 / const_754) + " hours ago";
         }
         if(param1 < 2 * const_755)
         {
            return Math.round(param1 / const_752) + " days ago";
         }
         return Math.round(param1 / const_755) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),_main,WindowTracker.const_898,_data.userId),_callerFrame,var_987,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_786.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(_main.getXmlWindow("user_info"));
            var_786.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ModActionCtrl(_main,_data.userId,_data.userName,var_1310),_callerFrame,var_987,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new RoomVisitsCtrl(_main,_data.userId),_callerFrame,var_987,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new SendMsgsCtrl(_main,_data.userId,_data.userName,var_1310),_callerFrame,var_987,false,true);
      }
