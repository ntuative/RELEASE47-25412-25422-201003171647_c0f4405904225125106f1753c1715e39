package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2210:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1564,this._model.mode != ThumbnailEditorModel.const_54);
         setEnabled(var_1563,this._model.mode != ThumbnailEditorModel.const_34);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1564 = IButtonWindow(find("top_tab"));
         var_1563 = IButtonWindow(find("obj_tab"));
         var_2210 = IWindowContainer(find("tile_grid"));
         var_2209 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1564,onTopTabButton);
         Util.setProcDirectly(var_1563,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2210;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_2209;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_58,HabboWindowStyle.const_38,HabboWindowParam.const_71,new Rectangle(0,0,param1.width,66)));
