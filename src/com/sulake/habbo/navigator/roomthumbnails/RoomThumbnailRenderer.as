package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1070:int = -16;
      
      private static const const_759:int = 32;
      
      private static const const_1069:int = 8;
      ...
      private var var_1855:Dictionary;
      ...
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1070,_loc4_.y + const_1068 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1855[param1]);
      }
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_759 / 2);
         return new Point(param1 * const_759 + _loc3_,param2 * const_1069);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         {
            var_1003[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1003[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_438)
         {
            if(false)
            {
               refreshObj(param1,var_1003[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1195 == null)
         {
            var_1195 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1195,var_1195.rect,new Point(0,0),null,null,true);
      }
   }
}
