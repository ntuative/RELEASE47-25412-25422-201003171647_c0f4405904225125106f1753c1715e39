package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_2008:Rectangle;
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_2006 = this._navigator.getButtonImage(this.var_2007);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_2008 == null)
         {
            ...
            this.var_2008 = new Rectangle(var_1505,var_1505,_loc1_.width - 2 * var_1505,_loc1_.height - 2 * var_1505);
         }
         var_695.bitmap.fillRect(var_695.bitmap.rect,4281545523);
         var_695.bitmap.fillRect(this.var_2008,4284900966);
         copyTo(var_695.bitmap);
         if(_selected)
         {
            var_695.bitmap.copyPixels(var_2005,var_2005.rect,new Point(0,0),null,null,true);
         }
         var_695.invalidate();
      }
