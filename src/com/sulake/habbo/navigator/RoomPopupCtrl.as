package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_2003 = new RoomThumbnailRenderer(param1);
         var_785 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_170,var_114.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_785.refreshTags(_loc1_,var_114.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2003.refreshThumbnail(_loc1_,var_114.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_170,var_114);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_170,!true ? getEventCtg(var_114.categoryId) : getRoomCtg(var_114.categoryId));
         refreshRoomDesc(var_170,var_114);
         refreshExtraCont();
         refreshInfo(var_170,"trading_allowed",var_114.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_199,Tabs.const_232,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
