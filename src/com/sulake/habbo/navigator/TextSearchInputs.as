package com.sulake.habbo.navigator
{
   ...
   public class TextSearchInputs
   {
      ...
      public function TextSearchInputs(param1:HabboNavigator, param2:Boolean, param3:IWindowContainer)
      {
         ...
         _navigator = param1;
         var_2336 = param2;
         var_643 = new TextFieldManager(_navigator,ITextFieldWindow(param3.findChildByName("search_str")),25,searchRooms,_navigator.getText("navigator.search.info"));
      ...
      {
         var _loc1_:String = var_643.getText();
         if(_loc1_ == "")
         {
            return;
         }
         _navigator.mainViewCtrl.startSearch(Tabs.const_199,Tabs.const_232,_loc1_);
      }
   }
}
