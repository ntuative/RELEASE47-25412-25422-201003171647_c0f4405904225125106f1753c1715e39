package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_689:TextFieldManager;
      ...
      private var var_826:IDropMenuWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_689.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_827.getText());
         addTag(_loc6_,var_828.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1945.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_689.setText(param1.eventDescription);
         var_827.setText(getTagFromEvent(param1,1));
         var_828.setText(getTagFromEvent(param1,2));
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1483 = IWindowContainer(find("event_type_disabled_cont"));
            var_1945 = ITextWindow(find("event_type_disabled_text"));
            var_1482 = ITextWindow(find("create_caption"));
            var_1481 = ITextWindow(find("edit_caption"));
            var_1222 = IButtonWindow(find("create_button"));
            var_1221 = IButtonWindow(find("edit_button"));
            var_1946 = IButtonWindow(find("cancel_button"));
            var_1223 = IButtonWindow(find("end_button"));
            var_826 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1222,onCreateButtonClick);
            Util.setProcDirectly(var_1221,onEditButtonClick);
            Util.setProcDirectly(var_1223,onEndButtonClick);
            Util.setProcDirectly(var_1946,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_689 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_827 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_828 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_689.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function createEvent() : void
      {
         ...
         var_689.goBackToInitialState();
         _eventNameInput.goBackToInitialState();
         var_827.goBackToInitialState();
         var_828.goBackToInitialState();
         var_826.selection = 0;
