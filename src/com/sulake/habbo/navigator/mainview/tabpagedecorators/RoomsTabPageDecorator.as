package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_283);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_661);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_283,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_460 == null)
         {
            var_460 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_460.procedure = onChangeFilter;
