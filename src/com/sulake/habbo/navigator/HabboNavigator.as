package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_891:ISessionDataManager;
      
      private var var_892:RoomCreateViewCtrl;
      
      private var var_2003:RoomThumbnailRenderer;
      
      private var var_189:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_599:RoomInfoViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_599 = new RoomInfoViewCtrl(this);
         var_892 = new RoomCreateViewCtrl(this);
         var_2003 = new RoomThumbnailRenderer(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_268.startSearch(Tabs.const_199,Tabs.const_337,param1);
      ...
      override public function dispose() : void
      {
         ...
         if(var_891)
         {
            var_891.release(new IIDSessionDataManager());
            var_891 = null;
         }
         if(_catalog)
         {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_152.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_189 != null)
         {
            var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_891 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_268.startSearch(Tabs.const_258,Tabs.const_214);
         var_394.getTab(Tabs.const_258).tabPageDecorator.tabSelected();
      }
