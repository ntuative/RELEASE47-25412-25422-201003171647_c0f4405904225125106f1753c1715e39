package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1229:ICheckBoxWindow;
      
      private var _navigator:HabboNavigator;
      
      private var var_1230:ICheckBoxWindow;
      ...
      private function populateForm() : void
      {
         ...
         var_1226.setText(_loc1_.description);
         var_1023.setText("");
         var_1224.setText("");
         ...
         setTag(var_827,_loc1_.tags[0]);
         setTag(var_828,_loc1_.tags[1]);
         if(var_1230)
         {
            if(_loc1_.allowPets)
            {
               this.var_1230.select();
            }
            else
            {
               this.var_1230.unselect();
            }
         }
         if(var_1229)
         {
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(var_255.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(var_255.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(var_255.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = var_255.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = var_255.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = var_255.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(var_255.findChildByName("flat_controllers_footer"));
         Util.hideChildren(var_255);
         var_255.findChildByName("ruler").visible = true;
         ...
         if(var_83.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(var_255,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_58,HabboWindowStyle.const_38,HabboWindowParam.const_71,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1485.visible = _inRoom;
         var_1487.visible = _inRoom;
         var_1950.visible = var_478;
         var_1951.visible = !var_478;
         if(var_478)
         {
            var_1021.visible = true;
            var_1228.visible = false;
            refreshFlatControllers();
            var_1021.height = Util.getLowestPoint(this.var_1021) + 4;
         }
         else
         {
            populateForm();
            var_1025.visible = true;
            var_1228.visible = true;
            var_1225.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1225.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_1025.height = Util.getLowestPoint(this.var_1025) + 4;
         }
         var_1484.text = !!var_478 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1485.name,var_1225.name,var_1025.name,var_1021.name,var_1228.name,var_1487.name],0,0);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = var_1226.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_429;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_133)
         {
            _loc8_ = var_1023.getText();
            _loc9_ = var_1224.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1023.clearErrors();
               this.var_1224.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = var_1230.isSelected;
         _loc2_.allowFoodConsume = var_1229.isSelected;
         _loc2_.allowWalkThrough = var_1227.isSelected;
         _loc2_.tags = new Array();
         addTag(var_827,_loc2_.tags);
         addTag(var_828,_loc2_.tags);
         this.clearErrors();
         this.var_1024 = _loc2_.roomId;
      ...
      {
         if(param1 != this.var_402 || var_1024 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_1024 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1318)
         {
            this.var_829.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1277)
         {
         ...
         {
            this.var_1226.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1391)
         {
            setTagError(this.var_827,param3,"${navigator.roomsettings.unacceptablewords}");
            setTagError(this.var_828,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1195)
         {
            setTagError(this.var_827,param3,"${navigator.roomsettings.nonuserchoosabletag}");
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_510,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_853,onDoorModePasswordUnselect);
         getSaveButton().addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onSaveButtonClick);
         method_7().addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCancelButtonClick);
         ...
         this.var_1226 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_827 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_828 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_1023 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1224 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1230 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1229 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1227 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1485 = IWindowContainer(_window.findChildByName("header_container"));
         var_1225 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_1025 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_1021 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1487 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1228 = IWindowContainer(_window.findChildByName("footer_container"));
         var_255 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_1022 = IWindowContainer(_window.findChildByName("password_container"));
         var_1951 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1950 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1484 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1484.procedure = onSwitchView;
         var_1022.visible = false;
         if(!_inRoom)
         {
