package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private var var_424:IRoomObjectEventHandler;
      ...
      public function RoomObject(param1:int, param2:int)
      {
         ...
         var_1548 = new Vector3d();
         var_511 = new Array(param2);
      ...
      {
         var_1548.assign(var_225);
         return var_1548;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_511.length)
         {
            if(var_511[param2] != param1)
            {
               var_511[param2] = param1;
               ++_updateID;
            }
            return true;
         }
      ...
      public function setEventHandler(param1:IRoomObjectEventHandler) : void
      {
         ...
         var _loc2_:IRoomObjectEventHandler = var_424;
         if(_loc2_ != null)
         {
            var_424 = null;
            _loc2_.object = null;
      ...
      {
         if(param1 >= 0 && param1 < var_511.length)
         {
