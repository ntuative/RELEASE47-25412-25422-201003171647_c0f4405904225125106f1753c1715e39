package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_212:BitmapDataCache;
      
      private var _geometry:RoomGeometry;
      
      private var var_1649:Number = -10000000;
      
      private var var_1651:Number = -10000000;
      ...
      private var var_245:Sprite;
      
      private var var_956:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_212 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
      ...
      public function update() : void
      {
         if(var_954 == 0)
         {
            checkMouseHits(var_955.x,var_955.y,MouseEvent.MOUSE_MOVE);
         }
         var_954 = 0;
         ++var_1407;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_245 != null)
         {
            var_245.graphics.clear();
         }
         else
         {
            var_245 = new Sprite();
            var_245.name = "mask";
            _master.addChild(var_245);
         }
         var_245.graphics.beginFill(0);
         var_245.graphics.drawRect(0,0,param1,param2);
         var_637 = param1;
         var_639 = param2;
         var_52.graphics.clear();
         var_52.graphics.beginFill(var_2342);
      ...
      {
         var _loc11_:Number = param1 - var_637 / 2;
         var _loc12_:Number = param2 - var_639 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_637 != var_1648 || var_639 != var_1652)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_380.sortOn("z",0 | 0);
         if(_loc6_ < var_380.length)
         {
            var_380.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_380[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_638.push(_loc12_ - _loc2_);
         if(var_638.length == const_747)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_747)
            {
               _loc13_ += var_638[_loc14_];
               _loc14_++;
            }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_452.length)
            {
               cleanSprite(var_452[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_452 = [];
         }
         ...
         while(_loc1_ < var_294.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_956 != null)
                  {
                     var_956.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1407,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_212.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_212.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_380.length)
         {
            return null;
         }
         return var_380[param1] as SortableSprite;
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1649 || param2 != var_1651)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_452.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_212.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_212.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_212.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_212.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         _loc12_ += int(var_637 / 2);
         _loc13_ += int(var_639 / 2);
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_637 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_639))
                  {
