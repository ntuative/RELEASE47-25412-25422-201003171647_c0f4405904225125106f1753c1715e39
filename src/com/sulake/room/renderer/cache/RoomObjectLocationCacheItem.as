package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      {
         if(param1 != var_1307 || param2 != var_2010)
         {
            var_1307 = param1;
            var_2010 = param2;
            return true;
         ...
         if(param3)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  if(_loc8_ != null)
                  {
                     var_256 = new Vector3d(_loc5_.x,_loc5_.y,_loc8_.z);
                  }
                  else
                  {
                     var_256.assign(_loc5_);
                  }
               }
               else
               {
            ...
            var_256.x = Math.round(var_256.x);
            var_256.y = Math.round(var_256.y);
         }
         return var_256;
      }
