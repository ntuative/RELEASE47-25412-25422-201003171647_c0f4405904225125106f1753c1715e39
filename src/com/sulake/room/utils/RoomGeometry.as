package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_564:Number = 64;
      
      public static const const_1009:Number = 32;
      ...
      private var var_2349:Number = 500;
      ...
      private var var_2350:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_85 = new Vector3d();
         var_1015 = new Vector3d();
         var_1478 = 1;
         var_1479 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1480 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_401 != param1 * var_1480)
         {
            var_401 = param1 * var_1480;
            ++var_75;
         }
      }
      ...
      {
         if(var_398 != param1 * var_1478)
         {
            var_398 = param1 * var_1478;
            ++var_75;
         }
      }
      ...
      {
         if(var_399 != param1 * var_1479)
         {
            var_399 = param1 * var_1479;
            ++var_75;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_400 != null)
         {
            ...
            var_400.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_400.add(_loc3_,_loc4_);
            ++var_75;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1015.assign(_loc22_);
         }
         else
         {
            var_1015.assign(_loc17_);
         }
         ++var_75;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_399;
         _loc2_.z *= var_401;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1015);
         if(_loc3_ < var_2350 || _loc3_ > var_2349)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_399;
            _loc2_.z *= var_401;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1015);
         }
      ...
      {
         return new Vector3d(0 * var_398,0 * var_399,0 * var_401);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_400 != null)
         {
            ...
            return var_400.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_398,0 * var_399,0 * var_401);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_85;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_398,param2.y * var_399,param2.z * var_401);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_398,param3.y * var_399,param3.z * var_401);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_398,param4.y * var_399,param4.z * var_401);
