package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_481:IRoomObjectFactory = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_480 = [];
         var_466 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_297,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_478,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_736,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_35 == const_1379)
         {
            if(var_836 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(!var_45.hasInternalContent(param3))
         {
            ...
            _loc11_ = var_45.method_10(_loc12_);
         }
         else
         {
            _loc10_ = param3;
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_407.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_407.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = var_481.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_481 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = var_466.indexOf(param1);
         if(_loc2_ < 0)
         {
            return;
         }
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_481 != null)
         {
            return var_481.createRoomObjectManager();
         }
         return null;
      }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc18_ = var_45.method_10(_loc15_);
                           _loc5_ = var_407.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_407.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_481.createRoomObjectLogic(_loc18_);
