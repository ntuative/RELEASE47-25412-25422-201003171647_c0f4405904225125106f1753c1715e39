package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1398:Boolean = false;
      ...
      protected static const const_1399:Boolean = true;
      ...
      protected var var_1112:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_89 = 0;
         var_68 = 0;
         _horizontal = param2 == WindowType.const_322;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_162 = var_755 || !testParamFlag(WindowParam.const_33);
         _container = _context.create("_CONTAINER","",WindowType.const_286,WindowStyle.const_319,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_289,containerEventHandler);
         _container.addEventListener(WindowEvent.const_465,containerEventHandler);
         resizeOnItemUpdate = var_1112;
      }
      ...
      {
         return new Rectangle(var_529 * maxScrollH,var_531 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_289,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1022,_spacing,PropertyStruct.const_60,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1024,var_756,PropertyStruct.const_56,var_756 != const_1399));
         _loc1_.push(new PropertyStruct(const_1023,var_530,PropertyStruct.const_56,var_530 != const_1398));
         _loc1_.push(new PropertyStruct(const_1025,var_1112,PropertyStruct.const_56,var_1112 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_531 = param1;
            _container.y = -var_531 * maxScrollV;
            _context.invalidate(_container,visibleRegion,WindowRedrawFlag.const_73);
         }
      }
