package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1021:String = "tool_tip_caption";
      ...
      protected var var_2283:uint = 0;
      
      protected var var_933:String = "";
      
      protected var var_444:Array;
      
      protected var var_934:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_444 = new Array();
         var_444[0] = MouseCursorType.const_327;
         var_444[1] = MouseCursorType.const_38;
         var_444[2] = MouseCursorType.const_327;
         var_444[3] = MouseCursorType.const_327;
         var_444[4] = MouseCursorType.const_38;
         var_444[5] = MouseCursorType.const_38;
         var_444[6] = MouseCursorType.const_327;
         if(var_326 == null)
         {
            var_326 = new Array();
            ...
            var_326[4] = WindowState.const_46;
      ...
      {
         param2.push(new PropertyStruct(const_1021,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_739));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_855,param1.toolTipDelay != const_1397));
         return param2;
      }
      ...
      {
         var_933 = param1 == null ? const_739 : param1;
      }
