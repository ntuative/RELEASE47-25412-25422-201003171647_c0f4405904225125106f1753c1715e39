package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_899:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_353)
         {
            var_353 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_353)
            {
               var_353.addEventListener(WindowEvent.const_255,scrollBarEventProc);
               var_353.addEventListener(WindowEvent.const_226,scrollBarEventProc);
            }
         }
         return var_353;
      }
      ...
      override public function dispose() : void
      {
         if(var_353)
         {
            var_353.removeEventListener(WindowEvent.const_255,scrollBarEventProc);
            var_353.removeEventListener(WindowEvent.const_226,scrollBarEventProc);
            var_353 = null;
         }
         if(var_899)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_899)
         {
            var_899 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_899;
      }
