package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_932:ITabSelectorWindow;
      
      private var var_795:Boolean = false;
      
      protected var var_1602:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1602 == null)
         {
            var_1602 = findChildByTag(TabContextController.TAB_CONTEXT_CONTENT_TAG) as IWindowContainer;
         }
         return var_1602;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_932 == null)
         {
            var_932 = findChildByTag(TabContextController.TAB_CONTEXT_SELECTOR_TAG) as ITabSelectorWindow;
            if(var_932 != null)
            {
               var_932.procedure = selectorEventProc;
            }
         }
         return var_932;
      }
      ...
      {
         return !!var_795 ? selector.iterator : null;
      }
