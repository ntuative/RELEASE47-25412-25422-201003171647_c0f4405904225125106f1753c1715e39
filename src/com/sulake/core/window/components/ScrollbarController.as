package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1075:String = "increment";
      
      private static const const_489:String = "slider_bar";
      
      private static const const_1074:String = "decrement";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_162 = false;
         var_22 = param12;
         _horizontal = param2 == WindowType.const_417;
      ...
      {
         return findChildByName(ScrollbarController.const_763) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_830 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_830 != null)
         {
            _loc1_ = findParentByName(var_830) as IScrollableWindow;
            if(_loc1_ == null && var_8 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_8).findChildByName(var_830) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1075)
            {
               if(var_22)
               {
                  var_579 = true;
            ...
            else if(param2.name == ScrollbarController.const_1074)
            {
               if(var_22)
               {
                  var_579 = true;
         ...
         if(param1.type == WindowMouseEvent.const_865)
         {
