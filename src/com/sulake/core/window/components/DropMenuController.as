package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private var var_136:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_136 == null || false)
         {
            var_136 = context.create(name + "::submenu","",WindowType.const_458,var_80,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
            var_136.setGlobalRectangle(_loc1_);
         }
         var_136.activate();
         return var_136;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_897)
         {
            if(param2 == var_136)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_390,var_80,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_286,var_80,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_492 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_492).setStateFlag(WindowState.const_46,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_592)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_493,getSubMenu(),subMenuEventProc);
                  var_592 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_427,this,null,true);
         update(this,_loc2_);
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_136 != null)
            {
               _loc2_ = var_136.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_592 = false;
            getTitleText().text = var_492 < var_493.length && var_492 > -1 ? "null" : caption;
         }
      }
   }
}
