package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_769:String = "margin_top";
      
      private static const const_1100:String = "_HEADER";
      
      private static const const_770:String = "margin_right";
      
      private static const const_1101:String = "_SCALER";
      
      private static const const_1088:String = "_TITLE";
      
      private static const const_1102:String = "_CONTENT";
      
      private static const const_771:String = "margin_left";
      
      private static const const_772:String = "margin_bottom";
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_771,_loc3_.left,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_769,_loc3_.top,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_770,0 - _loc3_.right,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_772,0 - _loc3_.bottom,PropertyStruct.const_60,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_272);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_196);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1293 == null)
         {
            var_1293 = findChildByTag(const_1100) as IHeaderWindow;
            if(!var_1293)
            {
      ...
      {
         return findChildByTag(const_1101) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_262,false);
         }
      ...
      {
         return content != null && var_1380 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_21 == null)
         {
            var_21 = findChildByTag(const_1102) as IWindowContainer;
            if(!var_21)
            {
