package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1087:String = "_CONTROLS";
      ...
      {
         return findChildByTag(HeaderController.const_1088) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(HeaderController.const_1087) as IItemListWindow;
      }
   }
}
