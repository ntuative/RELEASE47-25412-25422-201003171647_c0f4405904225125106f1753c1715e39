package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1537:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_16)
         {
            var_16 = getGraphicContext(!testParamFlag(WindowParam.const_33));
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_121,WindowParam.const_142);
         var _loc2_:* = !testParamFlag(WindowParam.const_113,WindowParam.const_143);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_169)
               {
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_292)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         var_755 = param1;
         var_625 = !!var_755 ? uint(var_625 | var_1386) : uint(var_625 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2142 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            case WindowNotifyEvent.const_682:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_219:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1248:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1358:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_883:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_639:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_662:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_202:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_978:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_659:
               _loc2_ = "null";
               break;
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_926;
         update(this,_loc1_);
         return true;
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_511,var_7);
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_856,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_913;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_7,WindowRedrawFlag.const_917);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1063 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_302,this,param1));
         return param1;
      }
      ...
      {
         return !testParamFlag(WindowParam.const_33) || var_16 != null;
      }
      ...
      {
         var_1386 = param1 & 4278190080;
         var_625 = !!var_755 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_7,WindowRedrawFlag.const_73);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_521))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_791;
                  if(testParamFlag(WindowParam.const_317))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                  ...
                  if((var_18 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_272))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_219:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_441,this,null));
                     if(testParamFlag(WindowParam.const_169,WindowParam.const_142))
                     {
                     ...
                     if(var_8 != null)
                     {
                        ...
                        var_18 = _loc8_;
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_233,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_435:
                  _context.invalidate(this,var_7.union(var_55),WindowRedrawFlag.const_470);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_976,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_267,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_310:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_662,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_202,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_364:
                  _context.invalidate(this,var_7,WindowRedrawFlag.const_931);
                  break;
               case WindowNotifyEvent.const_375:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_482:
                  if(!(var_18 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_7,WindowRedrawFlag.const_470);
                     }
                  }
                  else if(var_18 & 0)
                  {
               ...
               case WindowNotifyEvent.const_202:
                  ...
                  break;
               case WindowNotifyEvent.const_441:
                  var_8.getRegionProperties(null,var_310);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_302:
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_862,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_659,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_639;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1063 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_383)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_841,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_682,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_219,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_65,true);
         _loc1_.type = WindowNotifyEvent.const_1218;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_162 && var_753 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_7.width && param1.y <= var_7.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1537,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1537,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1137,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_65,false);
         _loc1_.type = WindowNotifyEvent.const_1193;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               var_310 = var_8.rectangle.clone();
               var_55.x = var_7.x;
               var_55.y = var_7.y;
               var_55.width = var_7.width;
               var_55.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_365,this,var_8));
            }
            else
            {
               var_310.x = 0;
               ...
               var_310.width = 0;
               var_310.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_978,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,var_18,_context,var_7,null,var_622,properties,var_626.concat(),_id) as WindowController;
         ...
         _loc2_.var_625 = var_625;
         _loc2_.var_1386 = var_1386;
         _loc2_.var_1111 = var_1111;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_404;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_35 == WindowState.const_392)
         {
            return true;
         }
         var_35 = WindowState.const_392;
