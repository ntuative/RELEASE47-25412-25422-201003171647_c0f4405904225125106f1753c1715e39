package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_608 = new Array();
         var_1557 = new Point();
         var_1558 = new Rectangle();
         var_314 = new Rectangle();
         var_313 = new Dictionary(true);
         var_742 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_313[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_608.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_314.x = _loc3_.dirty.x;
               var_314.y = _loc3_.dirty.y;
               var_314.width = _loc3_.dirty.width;
               var_314.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_314);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_535,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_313[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1557,var_1558))
            {
               if(param2.render(param1,var_1557,var_1558))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_742);
            var_313[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_535,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_314.x = param2.x - param1.x;
            var_314.y = param2.y - param1.y;
            ...
            if(param1.testParamFlag(WindowParam.const_33))
            {
               while(param1.testParamFlag(WindowParam.const_33))
               {
                  ...
                  var_314.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_314,WindowRedrawFlag.const_261);
            if(var_608.indexOf(param1) == -1)
            {
               var_608.push(param1);
            }
         }
