package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1031:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(var_1414,var_1681);
         var_1138 = new Dictionary();
         var_1680 = new Dictionary();
         StateCodeTable.fillTables(var_1138,var_1680);
         ...
         {
            var_372 = new Array();
            var_372.push(WindowState.const_65);
            var_372.push(WindowState.const_69);
            var_372.push(WindowState.const_97);
            var_372.push(WindowState.const_46);
            var_372.push(WindowState.const_79);
            var_372.push(WindowState.const_72);
            var_372.push(WindowState.const_92);
            var_372.push(WindowState.const_88);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1138)
         {
            _loc3_.push(var_1138[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1414[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_541[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_541[param1] = new Array(SkinContainer.const_1031);
         }
         var_541[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_541[_loc1_]).dispose();
