package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_965:String = "_EXCLUDE";
      
      public static const const_1551:String = "_TEMP";
      
      private static const const_1118:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1119:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      {
         param1 = param1.replace(const_1119,"");
         return param1.replace(const_1118,"");
      }
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_169)
                     {
                        window.x = rect.x;
                     }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_965) == -1)
                  {
