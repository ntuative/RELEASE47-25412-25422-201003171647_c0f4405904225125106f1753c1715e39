package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1030:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_582:uint = 0;
      
      public static const const_1007:String = "AssetLibraryReady";
      
      public static const const_1236:String = "AssetLibraryUnloaded";
      
      public static const const_483:String = "AssetLibraryLoaded";
      
      public static const const_1140:String = "AssetLibraryLoadError";
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_694)
         {
            delete var_694[_loc1_];
         }
         if(var_17 != null)
         {
            var_17.dispose();
         ...
         var_302 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1236));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_483 = _loc2_.manifest.copy();
         var_341 = _loc2_.resource;
         if(var_482)
         {
            AssetLibrary.fetchLibraryContents(this,var_483,var_341);
         }
         var_302 = true;
         dispatchEvent(new Event(AssetLibrary.const_483));
         dispatchEvent(new Event(AssetLibrary.const_1007));
         if(var_482)
         {
            var_17.dispose();
            var_17 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_907,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1030.splice(var_1030.indexOf(this),1);
            --var_582;
            var_409 = null;
            var_694 = null;
            _loadedAssets = null;
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1140));
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_483.child("library");
         if(_loc2_ == null)
         {
